    ...
    function() {
        ...
        window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), c.Utils = {
            ...
            setUpRenderer: function() {
                if (this.config.canvasID ? this.canvas = c.Canvas.create(this.width, this.height, this.config.canvasID) : this.canvas = c.Canvas.create(this.width, this.height), this.config.canvasStyle ? this.canvas.style = this.config.canvasStyle : this.canvas.style["-webkit-full-screen"] = "width: 100%; height: 100%", this.device.cocoonJS && (this.renderType === c.CANVAS ? this.canvas.screencanvas = !0 : this.canvas.screencanvas = !1), this.renderType === c.HEADLESS || this.renderType === c.CANVAS || this.renderType === c.AUTO && this.device.webGL === !1) {
            ...
            _crop: null,
            crop: function(a, b) {
                "undefined" == typeof b && (b = !1), a ? (b && null !== this.cropRect ? this.cropRect.setTo(a.x, a.y, a.width, a.height) : b && null === this.cropRect ? this.cropRect = new c.Rectangle(a.x, a.y, a.width, a.height) : this.cropRect = a, this.updateCrop()) : (this._crop = null, this.cropRect = null, this.resetFrame())
            },
            updateCrop: function() {
                if (this.cropRect) {
        ...
        c.Button.prototype.clearFrames = function() {
            ...
            setPixel32: function(a, b, d, e, f, g, h) {
                return "undefined" == typeof h && (h = !0), a >= 0 && a <= this.width && b >= 0 && b <= this.height && (c.Device.LITTLE_ENDIAN ? this.pixels[b * this.width + a] = g << 24 | f << 16 | e << 8 | d : this.pixels[b * this.width + a] = d << 24 | e << 16 | f << 8 | g, h && (this.context.putImageData(this.imageData, 0, 0), this.dirty = !0)), this
            },
            ...
            fileComplete: function(a, b) {
                ...
                switch (a.type) {
                    ...
                    case "script":
                        ...
                        break;
                    case "binary":
                        a.callback ? a.data = a.callback.call(a.callbackContext, a.key, b.response) : a.data = b.response, this.game.cache.addBinary(a.key, a.data)
                }
        ...
        }, c.Utils.mixinPrototype(c.Physics.Arcade.prototype, c.Physics.Arcade.TilemapCollision.prototype), c.Particles = function(a) {
