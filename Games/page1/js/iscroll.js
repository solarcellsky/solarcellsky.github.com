...
(function (window, document, Math) {
    ...
    function IScroll(el, options) {
        ...
        //Add by zhaoming ±ÜÃâ³öÏÖloading²ã
        this.scale = 1;
        //var pages = $(this.wrapper).find('.ui-page-active');
        //if (pages.length == 0)
        this.scroller = this.wrapper.children[0];
        //else
        //this.scroller = pages[0];
    ...
    IScroll.prototype = {
        ...
        refresh: function () {
            ...
            //change by zhaoming
            this.scrollerHeight = Math.round((this.scroller.offsetHeight + this.minScrollY) * this.scale);
