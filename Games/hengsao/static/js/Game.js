...
(function (e, t) {
    ...
    var r = e.Best = e.Best || {}, i = r.Game = function (e) {
        for (var t in e)this[t] = e[t]
    };
    i.prototype = {constructor: i, id: null, width: 600, height: 400, FPS: 60, caption: "", context: null, init: function () {
        var e = this;
        this._run = function () {
            e.run()
        }, this.timer = {now: 0, last: 0, step: Math.round(1e3 / this.FPS)}, this.initGraphicContext(), this.onInit && this.onInit.apply(this, arguments)
        ...
        var e = this.timer.now = Date.now(), t = e - this.timer.last;
    ...
    }, onInit: null, onStart: null, onPause: null, onResume: null, onStop: null};
    var s = r.Scene = function (e) {
        for (var t in e)this[t] = e[t]
    };
    s.prototype = {constructor: s, id: null, init: function (e) {
    }, enter: function () {
    }, leave: function (e) {
    }, update: function (e, t) {
