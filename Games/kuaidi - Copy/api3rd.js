...
function(e, t) {
    ...
    function i() {
        ...
        //         e.id = Gt.slice(1),
        //         e.innerHTML = ['<div id="hw-bar" class="hw-bar">', "<header>", "<h4>\u58f9\u9009\u79d1\u6280\uff0c\u4e3a\u672a\u6765\u800c\u751f</h4>", '<div class="hw-clip">', '<div class="hw-clip-btn"><img src="' + ht + '/images/home/logo200.png"></div>', "</div>", "</header>", "<nav>", "<ul>", Ot.env.app ? "": '<li><a href="#" class="hw-btn-app" data-action="app">\u5b89\u88c5<strong>\u706b\u821eAPP</strong>\uff0c\u4f53\u9a8c\u7cbe\u54c1\u6e38\u620f</a></li>', Ot.env.wechat ? '<li><a href="#" data-action="share">\u6311\u6218\u597d\u53cb</a></li>': "", '<li><a href="#" data-action="more">\u66f4\u591a\u6e38\u620f</a></li>', '<li><a href="#" class="hw-btn-resume" data-action="close">\u8fd4\u56de\u6e38\u620f</a></li>', "</ul>", "</nav>", "</div>"].join(" "),
    ...
    function(t) {
        ...
        w = {
            ...
            link: bt,
            query: "",
            title: b.title || Z.title || "\u58f9\u9009\u79d1\u6280",
            desc: b.desc || Z.title || "\u58f9\u9009\u79d1\u6280"
        };
