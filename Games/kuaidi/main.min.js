...
function(t) {
    ...
    t.openGameRulePanelNotify = "openGameRulePanelNotify",
...
function(t) {
    function e() {
        ...
        Global.addEventListener(MainNotify.openGameRulePanelNotify, this.openGameRulePanelNotify, this),
...
var GamePanel = function(t) {
    ...
    p.initGame = function() {
        ...
        this.score_label.textColor = 8388608,
    ...
    p.gameOver = function() {
        ...
        this, 3e3),
        egret.setTimeout(function() {
            var m = document.getElementById('myphone');
            var c = document.getElementById('cancel');
            var s =  document.getElementById('sendPhone');
...
var StartPanel = function(t) {
    ...
    p.initPanel = function() {
        ...
        i.x = t / 2 - i.width / 2,
        i.y = 220;
        var n = new EButton(this, "game_start_label_png", this.gameBegin);
        this.addChild(n),
        n.x = t / 2 - n.width / 2,
        n.y = 680;
        var r = new EButton(this, "game_rule_label_png", this.rulePanel);
        this.addChild(r),
        r.x = t / 2 - r.width / 2,
        r.y = 780;
        this.bg.addEventListener(egret.TouchEvent.TOUCH_TAP, this.gameBegin, this),
        this.touchEnabled = !0;
        var s = new EToggleButton(this, "music_close_png", "music_open_png", function() {
