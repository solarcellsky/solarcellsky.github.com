...
(function(b) {
    var d = function(e) {
        ...
        a._dispatchByTarget = function(c, a, k, e, d, f) {
            void 0 === d && (d = !1);
            void 0 === f && (f = !1);
            var h = c.eventRecycler;
            h || (h = c.eventRecycler = new b.Recycler);
            var n = h.pop();
            n ? n._type = k : n = new c(k);
            n._bubbles = d;
            n._cancelable = f;
            if (e)
        ...
        a.dispatchEvent = function(c, l, b, e) {
            void 0 === b && (b = !1);
...
(function(b) {
    var d = function(e) {
        ...
        a.dispatchTouchEvent = function(c, l, k, e, d, f, h, n, p) {
            void 0 === k && (k = 0);
            void 0 === e && (e = 0);
            void 0 === d && (d = 0);
            void 0 === f && (f = !1);
...
(function(b) {
    var d = function(e) {
        ...
        __extends(a, e);
        a.dispatchProgressEvent = function(c, l, k, e) {
            void 0 === k && (k = 0);
            void 0 === e && (e = 0);
            b.Event._dispatchByTarget(a, c, l, {
                bytesLoaded: k,
...
(function(b) {
    var d = function(e) {
        ...
        __extends(a, e);
        a.prototype.addEventListener = function(c, a, k, e, d) {
            void 0 === e && (e = !1);
            void 0 === d && (d = 0);
            ...
            var f = e[c];
            f || (f = e[c] = []);
            this._insertEventBin(f, a, k, d)
        };
        a.prototype._insertEventBin = function(c, a, b, e, d) {
            void 0 === d && (d = void 0);
            for (var f = -1, h = c.length, n = 0; n < h; n++) {
                var p = c[n];
                if (p.listener === a && p.thisObject === b && p.display === d) return !1; - 1 == f && p.priority < e && (f = n)
            }
            a = {
                listener: a,
                thisObject: b,
            ...
            d && (a.display = d); - 1 != f ? c.splice(f, 0, a) : c.push(a);
            return !0
        };
        ...
        a.prototype._removeEventBin = function(c, a, b, e) {
            ...
            for (var d = c.length, f = 0; f < d; f++) {
                var h = c[f];
                if (h.listener === a && h.thisObject === b && h.display === e) return c.splice(f, 1), !0
            }
            return !1
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.broadcastEnterFrame = function(c) {
            ...
            for (var a = b.DisplayObject._enterFrameCallBackList.concat(), k = a.length, e = 0; e < k; e++) {
                var d = a[e];
                c._target = d.display;
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.setTimeout = function(c, a, k) {
            ...
            b.setTimeout.apply(null, [c, a, k].concat(e))
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.append =
            function(c, a, b, e, d, f) {
                var h = this.a,
                    ...
                    p = this.c,
                    q = this.d;
                if (1 != c || 0 != a || 0 != b || 1 != e) this.a = c * h + a * p, this.b = c * n + a * q, this.c = b * h + e * p, this.d = b * n + e * q;
                this.tx = d * h + f * p + this.tx;
                this.ty = d * n + f * q + this.ty;
                return this
            };
        a.prototype.prependTransform = function(c, a, k, e, d, f, h, n, p) {
            if (d % 360) {
                var q = b.NumberUtils.cos(d);
                d = b.NumberUtils.sin(d)
            } else q = 1, d = 0;
            if (n || p) this.tx -= n, this.ty -= p;
            f || h ? (this.prepend(q * k, d * k, -d * e, q * e, 0, 0), this.prepend(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(f), b.NumberUtils.cos(f),
                c, a)) : this.prepend(q * k, d * k, -d * e, q * e, c, a);
            return this
        };
        a.prototype.appendTransform = function(c, a, k, e, d, f, h, n, p) {
            if (d % 360) {
                var q = b.NumberUtils.cos(d);
                d = b.NumberUtils.sin(d)
            } else q = 1, d = 0;
            f || h ? (this.append(b.NumberUtils.cos(h), b.NumberUtils.sin(h), -b.NumberUtils.sin(f), b.NumberUtils.cos(f), c, a), this.append(q * k, d * k, -d * e, q * e, 0, 0)) : this.append(q * k, d * k, -d * e, q * e, c, a);
        ...
        a.transformCoords = function(c, a, k) {
            ...
            e.x = c.a * a + c.c * k + c.tx;
            e.y = c.d * k + c.b * a + c.ty;
            return e
        };
...
(function(b) {
    var d = function() {
        ...
        e.traceToConsole = function(a, c, l) {
            console.log(b.Logger.getTraceCode(a, c, l))
        };
        e.getTraceCode = function(a, c, l) {
            return "[" + a + "]" + c + ":" + (null == l ? "" : l)
        };
        return e
    }();
...
(function(b) {
    ...
    e = function() {
        ...
        c.prototype.init = function(c) {};
        c.prototype._apply = function(c, a, l) {};
        c.prototype.setEgretSize = function(c, a, l, k, e, p) {
            void 0 === p && (p = 0);
    ...
    l = function(c) {
        ...
        a.prototype._apply = function(c, a, l) {
            var b = this._getClientWidth(),
                ...
                d = l * m,
                b = Math.floor((b - e) / 2);
            c._offSetY = Math.floor((k - d) / 2);
            this.setEgretSize(a, l / 1, 1 * e, d, b, c._offSetY);
            c._scaleX = 1 * m;
            c._scaleY = 1 * m
        };
        return a
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.drawImage = function(c, a, k, e, d, f, h, n, p, q, r) {
            void 0 === r && (r = void 0);
            h = h || 0;
            n = n || 0;
                ...
                if (0 != this._drawAreaList.length && b.MainContext.instance.rendererContext._cacheCanvasContext) {
                    ...
                    for (var u = this.getDrawAreaList(), v = 0; v < u.length; v++)
                        if (!this.ignoreRender(a, u[v], s.destX, s.destY)) {
                            c.drawImage(t, k, e, d, f, h, n, p, q, r);
                            break
                        }
                } else c.drawImage(t, k, e, d, f, h, n, p, q, r)
            }
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.drawCacheTexture =
            function(c) {
                ...
                b.RenderFilter.getInstance().drawImage(c, this, 0, 0, d * f, a * f, k, e, d, a);
                return !0
            };
        ...
        a.prototype.getBounds =
            function(c, a) {
                ...
                var k = this._measureBounds(),
                    e = this._hasWidthSet ? this._explicitWidth : k.width,
                ...
                this._cacheBounds.initialize(f - h, k - n, e, d);
                e = this._cacheBounds;
                c || (c = new b.Rectangle);
        ...
        a.prototype.hitTest = function(c, a, k) {
            ...
            return 0 <= c && c < k.width && 0 <= a && a < k.height ? this.mask || this._scrollRect ? this._scrollRect && c > this._scrollRect.x && a > this._scrollRect.y && c < this._scrollRect.x + this._scrollRect.width && a < this._scrollRect.y + this._scrollRect.height || this.mask && this.mask.x <= c && c < this.mask.x + this.mask.width && this.mask.y <= a && a < this.mask.y + this.mask.height ?
                this : null : this : null
        };
        a.prototype.hitTestPoint = function(c, a, k) {
        ...
        a.prototype._getMatrix = function(c) {
            ...
            e ? (c.append(e.a, e.b, e.c, e.d, e.tx, e.ty), c.append(1, 0, 0, 1, -a, -k)) : c.appendTransform(this._x, this._y, this._scaleX, this._scaleY, this._rotation, this._skewX, this._skewY, a, k);
            return c
        };
        ...
        a.prototype.addEventListener = function(c, l, k, d, g) {
            void 0 === d && (d = !1);
            void 0 === g && (g = 0);
            e.prototype.addEventListener.call(this, c, l, k, d, g);
            ((d = c == b.Event.ENTER_FRAME) || c == b.Event.RENDER) && this._insertEventBin(d ? a._enterFrameCallBackList : a._renderCallBackList, l, k, g, this)
        };
        a.prototype.removeEventListener =
            function(c, l, k, d) {
                void 0 === d && (d = !1);
                e.prototype.removeEventListener.call(this, c, l, k, d);
                ((d = c == b.Event.ENTER_FRAME) || c == b.Event.RENDER) && this._removeEventBin(d ? a._enterFrameCallBackList : a._renderCallBackList, l, k, this)
            };
        a.prototype.dispatchEvent = function(c) {
    ...
    d = function() {
        ...
        b.prototype.updateColor = function(a, c, b, e, d, g, f, h) {};
        return b
    }();
    b.ColorTransform = d;
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype._doAddChild = function(c, l, e) {
            void 0 === e && (e = !0);
            if (c == this) return c;
        ...
        a.prototype.swapChildren = function(c, a) {
            var e = this._children.indexOf(c),
                d = this._children.indexOf(a); - 1 == e || -1 == d ? b.Logger.fatal("child\u672a\u88abaddChild\u5230\u8be5parent") : this._swapChildrenAt(e, d)
        };
        ...
        a.prototype.hitTest = function(c, a, k) {
            ...
            return d ? d : this._texture_to_render || this.graphics ? e.prototype.hitTest.call(this, c, a, k) : null
        };
        a.prototype._onAddToStage = function() {
    ...
    var d = function(e) {
        ...
        a.prototype._onTouchBeginCapture = function(c) {
            ...
            if (l) {
                for (var e = c.target; e != this;) {
                    if (e instanceof a && (l = e._checkScrollPolicy())) return;
                    e = e.parent
                }
                c.stopPropagation();
        ...
        a.prototype._moveAfterTouchEnd = function() {
            if (0 != this._velocitys.length) {
                for (var c = 0, b = 0, e = 0, d = 0; d < this._velocitys.length; d++) var g = this._velocitys[d],
                    f = a.weight[d],
                    c = c + g.x * f,
                    b = b + g.y * f,
                    e = e + f;
        ...
        a.prototype.getAnimationDatas = function(c, a, b) {
            ...
            if (0 > f || f > b)
                for (f =
                    a; Infinity != Math.abs(c) && 0.02 < Math.abs(c);) f += c, c = 0 > f || f > b ? 0.998 * c * 0.95 : 0.998 * c, d++;
        ...
        a.prototype.hitTest = function(c, a, d) {
            void 0 === d && (d = !1);
            var m = e.prototype.hitTest.call(this, c, a, d);
            return m ? m : b.DisplayObject.prototype.hitTest.call(this, c, a, d)
        };
        ...
        a._drawBitmap = function(c, b, e, d) {
            ...
            if (g) {
                ...
                if ("scale" == d.fillMode) {
                    ...
                    if (n && f - n.width < b && h - n.height < e) a.drawScale9GridImage(c, d, n, b, e);
                    else {
                        var n = g._offsetX,
                            p = g._offsetY,
                            q = g._bitmapWidth || f,
                ...
                } else a.drawRepeatImage(c, d, b, e, d.fillMode)
            }
        };
        ...
        a.drawScale9GridImage = function(c, a, e, d, g) {
            ...
            if (f && e) {
                ...
                var n = q + e.x,
                    ...
                    t = d - (t - e.right);
                h.drawImage(c,
                    a, q / f, r / f, e.x, e.y, u, v, e.x, e.y);
                h.drawImage(c, a, n / f, r / f, e.width, e.y, A, v, t - e.x, e.y);
                h.drawImage(c, a, p / f, r / f, x, e.y, u + t, v, d - t, e.y);
                h.drawImage(c, a, q / f, y / f, e.x, e.height, u, B, e.x, s - e.y);
                h.drawImage(c, a, n / f, y / f, e.width, e.height, A, B, t - e.x, s - e.y);
                h.drawImage(c, a, p / f, y / f, x, e.height, u + t, B, d - t, s - e.y);
                h.drawImage(c, a, q / f, w / f, e.x, z, u, v + s, e.x, g - s);
                h.drawImage(c, a, n / f, w / f, e.width, z, A, v + s, t - e.x, g - s);
                h.drawImage(c, a, p / f, w / f, x, z, u + t, v + s, d - t, g - s)
            }
        };
        a.prototype._measureBounds = function() {
            var c = this._texture;
                    ...
                    for (var q =
                        ...
                        if ("" != q[r]) {
                            ...
                            if (this._hasWidthSet)
                                if (d + t <= this._explicitWidth) h.elements.push({
                                    width: t,
                                    text: q[r],
                                    style: p.style
                                }), d += t;
                                    ...
                                    for (var s = 0, u = 0, v = q[r]; s < v.length; s++) {
                                        ...
                                        if (d + t > this._explicitWidth) break;
                                        u += t;
                                        d += t
                                    }
                                    0 < s && (h.elements.push({
        ...
        a.prototype.drawText = function(c) {
            ...
            if (a) {
                ...
                var e = this._hasWidthSet ? this._explicitWidth : this._textMaxWidth,
                    d = this._textMaxHeight + (this._numLines -
                        1) * this._lineSpacing,
                    g = 0,
                    f = 0;
                ...
                for (h = 0; f < this._numLines; f++) {
                    ...
                    for (var h = Math.round((e - n.width) * d), q = 0; q < n.elements.length; q++) {
                        ...
                        this._type == b.TextFieldType.INPUT ? c.drawText(this, r.text, h, g + (p - t) / 2, r.width) : (this._isFlow && c.setupFont(this, r.style), c.drawText(this, r.text, h, g + (p - t) / 2, r.width, r.style));
                        h += r.width
                    }
...
(function(b) {
    var d = function(b) {
        ...
        a.prototype.parseConfig = function(a) {
            a = a.split("\r\n").join("\n");
            a = a.split("\n");
            for (var b = this.getConfigByKey(a[3], "count"), e = {}, d = 4; d < 4 + b; d++) {
                var g = a[d],
        ...
        a.prototype.getConfigByKey = function(a, b) {
            for (var e = a.split(" "), d = 0, g = e.length; d < g; d++) {
                var f = e[d];
                if (b == f.substring(0, b.length)) return e = f.substring(b.length + 1), parseInt(e)
            }
            return 0
        };
        return a
...
(function(b) {
    ...
    var e = function() {
        function a(a, e) {
            ...
            this._isPlaying = !1;
            this._frameData = a;
            this._spriteSheet = new b.SpriteSheet(e)
        }
        ...
        a.prototype.playNextFrame = function(a) {
            ...
            this._currentFrameIndex == this._totalFrame && (this._currentFrameIndex =
                0, e.action != b.Event.COMPLETE && this.movieClip.dispatchEventWith(b.Event.COMPLETE))
        };
...
(function(b) {
    var d = function(b) {
        ...
        a.prototype.decode = function(a) {
            ...
            a = a.split("+").join(" ");
            for (var b, e = /[?&]?([^=]+)=([^&]*)/g; b = e.exec(a);) this.variables[decodeURIComponent(b[1])] = decodeURIComponent(b[2])
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.drawToTexture = function(c) {
            ...
            if (0 == d.width || 0 == d.height) return b.Logger.warning("egret.RenderTexture#drawToTexture:\u663e\u793a\u5bf9\u8c61\u6d4b\u91cf\u7ed3\u679c\u5bbd\u9ad8\u4e3a0\uff0c\u8bf7\u68c0\u67e5"), !1;
            ...
            if (c instanceof b.DisplayObjectContainer) {
                var e = c._anchorOffsetX,
                    m = c._anchorOffsetY;
                if (0 != c._anchorX || 0 != c._anchorY) e = c._anchorX * d.width, m = c._anchorY * d.height;
                this._offsetX = d.x + e;
                this._offsetY = d.y +
                    m;
                ...
                d = c._children;
                e = 0;
                for (m = d.length; e < m; e++) d[e]._updateTransform()
            }
...
(function(b) {
    var d = function(e) {
        ...
        a.prototype.onTouchEnd = function(a, e, d) {
            var m = this.touchingIdentifiers.indexOf(d); - 1 != m && (this.touchingIdentifiers.splice(m, 1), m = b.MainContext.instance.stage.hitTest(a, e)) && (a = this.getTouchData(d, a, e), delete this.touchDownTarget[d], d = a.beginTarget, a.target = m, this.dispatchEvent(b.TouchEvent.TOUCH_END, a), d == m ? this.dispatchEvent(b.TouchEvent.TOUCH_TAP,
    ...
    var d = function(e) {
        ...
        a.prototype.$ = function(c) {
            ...
            if (c = c instanceof HTMLElement ?
                c : e.querySelector(c)) c.find = c.find || this.$, c.hasClass = c.hasClass || function(a) {
...
(function(b) {
    var d = function() {
        ...
        e.parse = function(a) {
            ...
            for (var c = a.childNodes.length, d = !1, k = 0; k < c; k++) {
        ...
        e.parseNode = function(a) {
            ...
            d = b.length;
            for (m = 0; m < d; m++)
                if (g = e.parseNode(b[m])) c.children || (c.children = []), g.parent = c, c.children.push(g);
        ...
        e.findByPath = function(a, c, b) {
            var d = c.indexOf("."),
                m; - 1 == d ? (m = c, d = !0) : (m = c.substring(0, d), c = c.substring(d + 1), d = !1);
            if (a = a.children)
    ...
    var e = function() {
        ...
        a.prototype.readUTFBytes = function(a) {
            ...
            for (var e = new DataView(this.arraybytes); this.position < a;) {
                ...
                } else if (224 > d) b += String.fromCharCode((d & 63) << 6 | e.getUint8(this.position++) & 127);
                else if (240 > d) var g = e.getUint8(this.position++),
                    b = b + String.fromCharCode((d & 31) << 12 | (g & 127) << 6 | e.getUint8(this.position++) & 127);
                else var g = e.getUint8(this.position++),
                    f = e.getUint8(this.position++),
                    b = b + String.fromCharCode((d & 15) << 18 | (g & 127) << 12 | f << 6 & 127 | e.getUint8(this.position++) & 127)
            }
            return b
        };
...
(function(b) {
    var d = function(e) {
        ...
        a.removeTweens = function(c) {
            if (c.tween_count) {
                for (var b =
                        a._tweens, e = b.length - 1; 0 <= e; e--) b[e]._target == c && (b[e].paused = !0, b.splice(e, 1));
                c.tween_count = 0
            }
        };
        a.pauseTweens = function(a) {
            if (a.tween_count)
                for (var e = b.Tween._tweens, d = e.length - 1; 0 <= d; d--) e[d]._target == a && (e[d].paused = !0)
        };
        a.resumeTweens = function(a) {
            if (a.tween_count)
                for (var e = b.Tween._tweens, d = e.length - 1; 0 <= d; d--) e[d]._target == a && (e[d].paused = !1)
        };
        a.tick = function(c, b) {
            void 0 === b && (b = !1);
        ...
        a._register = function(c, e) {
            var d = c._target,
                m = a._tweens;
            if (e) d && (d.tween_count = d.tween_count ? d.tween_count + 1 : 1), m.push(c), a._inited || (b.Ticker.getInstance().register(a.tick, null), a._inited = !0);
            else
        ...
        a.prototype._appendQueueProps = function(c) {
            ...
            for (h in c)
                if (void 0 === this._initQueueProps[h]) {
                    e = this._target[h];
                    if (b = a._plugins[h])
                        for (d = 0, g = b.length; d < g; d++) e = b[d].init(this, h, e);
                    this._initQueueProps[h] = this._curQueueProps[h] = void 0 === e ? null : e
                }
            for (h in c) {
                e = this._curQueueProps[h];
                if (b = a._plugins[h])
                    for (f = f || {}, d = 0, g = b.length; d < g; d++) b[d].step && b[d].step(this, h, e, c[h], f);
            ...
            for (var e = [], d = c.length,
                ...
                if (h)
                    for (var f = h.length, n = 0; n < f; n++) {
                        var p = h[n]; - 1 == e.indexOf(p) && e.push(p)
            ...
            if (a) {
                ...
                if (b = a.groups)
                    for (e = b.length, d = 0; d < e; d++) {
                        for (var f = b[d], h = [], n = f.keys.split(","), p = n.length, q = 0; q < p; q++) g = n[q].trim(), (g = this.keyMap[g]) && -1 == h.indexOf(g) && h.push(g);
    ...
    var d = function(e) {
        ...
        a.prototype.loadGroup = function(a, e, d) {
            ...
            if (!this.itemListDic[e] && e)
                if (a &&
                    ...
                    d = a.length;
                    for (var m = 0; m < d; m++) a[m].groupName = e;
        ...
        a.prototype.onItemComplete = function(a) {
            ...
            if (e) {
                ...
                b.ResourceEvent.dispatchResourceEvent(this.resInstance, b.ResourceEvent.GROUP_PROGRESS, e, a, d, m);
                d == m && (a = this.groupErrorDic[e], this.removeGroupName(e), delete this.groupTotalDic[e], delete this.numLoadedDic[e], delete this.itemListDic[e], delete this.groupErrorDic[e], a ? b.ResourceEvent.dispatchResourceEvent(this,
...
(function(b) {
    var d = function(b) {
        ...
        a.prototype.getTexturePath = function(a, b) {
            var e = "",
                d = b.split("\n")[2],
                g = d.indexOf('file="'); - 1 != g && (d = d.substring(g + 6), g = d.indexOf('"'), e = d.substring(0,
                g));
            a = a.split("\\").join("/");
            g = a.lastIndexOf("/");
...
(function(b) {
    ...
    b.addEventListener = function(a, b, d, k, m) {
        void 0 === k && (k = !1);
        void 0 === m && (m = 0);
        e.addEventListener(a, b, d, k, m)
    };
    b.removeEventListener = function(a, b, d, k) {
        void 0 === k && (k = !1);
        e.removeEventListener(a, b, d, k)
    };
    var d = function(a) {
        function c() {
            a.call(this);
        ...
        c.prototype.onGroupComp = function(a) {
            if (a.groupName == c.GROUP_CONFIG) {
                ...
                a = d.length;
                for (e = 0; e < a; e++) g = d[e], this.loadGroup(g.name, g.priority);
                this.groupNameList = []
        ...
        c.prototype.destroyRes = function(a) {
            ...
            if (b) {
                var c =
                    this.loadedGroups.indexOf(a); - 1 != c && this.loadedGroups.splice(c, 1);
                a = b.length;
                for (var e = 0; e < a; e++) {
                    c = b[e];
                    c.loaded = !1;
    ...
    var d = function(e) {
        function a(a) {
            ...
            var b = this.canvasContext.setTransform,
                d = this;
            this._cacheCanvasContext.setTransform = function(a, c, e, h, n, p) {
                d._matrixA = a;
                d._matrixB =
                    c;
                d._matrixC = e;
                ...
                d._matrixTx = n;
                d._matrixTy = p;
                b.call(d._cacheCanvasContext, a, c, e, h, n, p)
            };
            this._matrixA = 1;
        ...
        a.prototype.clearRect = function(a, b, e, d) {
            this.canvasContext.clearRect(a, b, e * window.devicePixelRatio, d * window.devicePixelRatio)
        };
        a.prototype.drawImage = function(a, d, k, m, g, f, h, n, p, q) {
            void 0 === q && (q = void 0);
            var r = a._bitmapData;
            f += this._transformTx;
            h += this._transformTy;
            var t = b.getTimer();
            void 0 === q ? this._cacheCanvasContext.drawImage(r, d, k, m, g, f, h, n, p) : this.drawRepeatImage(a, d, k, m, g, f, h, n, p, q);
            e.prototype.drawImage.call(this, a, d, k, m, g, f, h, n, p, q);
            this.renderCost +=
                b.getTimer() - t
        };
        a.prototype.drawRepeatImage = function(a, e, d, m, g, f, h, n, p, q) {
            if (void 0 === a.pattern) {
                var r = b.MainContext.instance.rendererContext.texture_scale_factor,
                    t = a._bitmapData,
                    s = t;
                if (t.width != m || t.height != g || 1 != r) s = document.createElement("canvas"), s.width = m * r, s.height = g * r, s.getContext("2d").drawImage(t, e, d, m, g, 0, 0, m * r, g * r);
        ...
        a.prototype.drawText = function(a, d, k, m, g, f) {
            void 0 === f && (f = null);
            this.setupFont(a, f);
            f = f || {};
            var h;
            ...
            q.fillStyle = h;
            q.strokeStyle = n;
            p && (q.lineWidth = 2 * p, q.strokeText(d, k + this._transformTx, m + this._transformTy, g || 65535));
            q.fillText(d, k + this._transformTx, m + this._transformTy, g || 65535);
            e.prototype.drawText.call(this, a, d, k, m, g, f)
        };
        ...
        a.prototype.onRenderFinish = function() {
            this._cacheCanvasContext.restore();
            this._cacheCanvasContext.setTransform(1, 0, 0, 1, 0, 0);
            for (var a = this._cacheCanvas.width, e = this._cacheCanvas.height, d = b.RenderFilter.getInstance().getDrawAreaList(), m = 0, g = d.length; m < g; m++) {
                var f = d[m],
                    h = f.x,
                    n = f.y,
                    p = f.width,
...
(function(b) {
    ...
    b.drawRoundRect = function(b, a, c, l, k, m) {
        this.commandQueue.push(new d(function(a, b, c, e, d, l) {
    ...
    b.drawEllipse = function(b, a, c, l) {
        this.commandQueue.push(new d(function(a, b, c, e) {
            ...
            this.canvasContext.beginPath();
            this.canvasContext.moveTo((a + c) / l, b / e);
            this.canvasContext.arc(a / l, b / e, d, 0, 2 * Math.PI);
            this.canvasContext.closePath();
...
(function(b) {
    var d = function(e) {
        function a(a) {
            ...
            for (var d = 0, k = 0; d < a; d += 6, k += 4) this.indices[d + 0] = k + 0, this.indices[d + 1] = k + 1, this.indices[d + 2] = k + 2, this.indices[d + 3] = k + 0, this.indices[d + 4] = k + 2, this.indices[d + 5] = k + 3;
            this.initWebGL();
            ...
            for (g *= q; f < n; f += m)
                for (var r = h; r < p; r += g) {
                    var t = Math.min(m, n - f),
                        s = Math.min(g, p - r);
                    this.drawImage(a, e, d, t / q, s / q, f, r, t, s)
                }
        };
        a.prototype.drawImage = function(a, b, e, d, g, f, h, n, p, q) {
            void 0 === q && (q = void 0);
            if (!this.contextLost)
                if (void 0 !==
                    q) this.drawRepeatImage(a, b, e, d, g, f, h, n, p, q);
                else {
...
var XiaobinTool = function() {
    ...
    b.creatMovieClip = function(b, e, a) {
        void 0 === a && (a = "");
        b = RES.getRes(b);
        var c = RES.getRes(e);
    ...
    b.hitTest = function(b, e) {
        ...
        c.width = e.width * e.scaleX;
        c.height = e.height * e.scaleY;
...
var __extends = this.__extends || function(b, d) {
    ...
    ScoreSixMc = function(b) {
        ...
        d.prototype.setNum = function(b) {
            ...
            b = b.slice(b.length - 1, b.length);
            this.thousandText.gotoAndStop("n" +
                b.toString());
...
var XiaobinDrager = function() {
    ...
    b.setMcDragable = function(d) {
        if (!1 == b.isInit) {
            ...
            e.addEventListener(egret.Event.LEAVE_STAGE, this.onTouchEnd, this)
        }
        this.mcArr.push(d)
    };
    b.onTouchMove = function(d) {
        !0 != b.gameOver && !0 == b.canMove && b.theMc && (b.theMc.x =
            d.stageX - b.localX, b.theMc.y = d.stageY - b.localY, b.theMc.y = Math.max(b.theMc.y, 500), b.theMc.y = Math.min(b.theMc.y, 630))
    };
    b.onTouchBegin = function(d) {
        if (!0 != b.gameOver)
            for (var e = this.mcArr.length - 1; 0 <= e; e--)
                if (this.mcArr[e].hitTestPoint(d.stageX, d.stageY, !0)) {
                    b.theMc = this.mcArr[e];
                    d = b.theMc.globalToLocal(d.stageX, d.stageY);
                    this.localX = d.x * b.theMc.scaleX;
                    this.localY = d.y * b.theMc.scaleY;
                    this.canMove = !0;
                    b.theMc.gotoAndPlay("run");
                    break
                }
    };
    b.onTouchEnd = function(d) {
        !0 != b.gameOver && (this.canMove = !1, null != b.theMc &&
            (b.theMc.gotoAndPlay("stand"), b.theMc = null), console.log("onTouchEnd"))
    };
    b.gameOver = !1;
    b.sec = 0;
    b.score = 0;
...
var __extends = this.__extends || function(b, d) {
    ...
    GameOverPanel = function(b) {
        ...
        d.prototype.ats = function(b) {
            ...
            b = XiaobinTool.createBitmapByName("gameover_png");
            this.addChild(b);
            this.sixScoreMc = new ScoreSixMc;
            this.addChild(this.sixScoreMc);
            this.sixScoreMc.scaleX = this.sixScoreMc.scaleY = 0.8;
            this.sixScoreMc.x = 100;
            this.sixScoreMc.y = 440;
            this.sixScoreMc.setNum(d.score);
            this.touchEnabled = !1;
            this.t = new egret.TextField;
            this.addChild(this.t);
            this.t.size = 28;
            this.t.x = 35;
            this.t.y = 60;
            this.t.lineSpacing = 20;
            this.t.textColor = 0;
            this.t.text = 50 > d.score ? "\u8fd9\u79cd\u6577\u884d\u7684\u901f\u5ea6\uff0c\n\u771f\u662f\u4eba\u95f4\u7f55\u89c1\u554a" : 100 > d.score ? "\u62a2\u7ea2\u5305\u90fd\u4e0d\u52aa\u529b\uff0c\n\u4f60\u4ee5\u4e3a\u4f60\u662f\u738b\u601d\u806a\u554a\uff01" :
                150 > d.score ? "\u6307\u529b\u5f3a\uff0c\u901f\u5ea6\u5feb\uff01\n\u660e\u5e74\u4e00\u5b9a\u9ad8\u5bcc\u5e05\uff01" : 200 > d.score ? "\u95ea\u7535\u4fa0\uff0c\u5c31\u662f\u4f60\uff01\n\u7f8a\u5e74\u4e00\u5b9a\u884c\u5927\u8fd0\uff01" : 250 > d.score ? "\u571f\u8c6a\uff01\u6211\u7231\u4f60\uff01\n\u5927\u5bb6\u505a\u4e2a\u670b\u53cb\u5457\uff01" : 300 > d.score ? "\u4f60\u79bb\u4eba\u751f\u7684\u5dc5\u5cf0\n\u5df2\u7ecf\u4e0d\u8fdc\u9e1f~~" : 350 > d.score ? "\u5927\u4e2d\u534e\u5730\u533a\n\u5df2\u65e0\u5bf9\u624b\uff01" :
                400 > d.score ? "\u5168\u4e16\u754c\u5730\u533a\n\u5df2\u65e0\u5bf9\u624b\uff01" : 450 > d.score ? "\u5168\u5b87\u5b99\u5730\u533a\n\u5df2\u65e0\u5bf9\u624b\uff01" : "\u80fd\u5230\u8fd9\u4e2a\u6210\u7ee9,\n\u4eba\u751f\u8d62\u5bb6\u5c31\u662f\u4f60\uff01";
            b = XiaobinTool.createBitmapByName("share_btn_png");
            this.addChild(b);
            b.x = 0.5 * this.stageW - b.width / 2 + 20;
            b.y = this.stageH - 480;
            b.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.doShare, this);
            b.touchEnabled = !0;
            var a = "\u62a2\u7ea2\u5305\uff0c\u6d4b\u8d22\u8fd0\uff0c\u6211\u62a2\u5230" +
                d.score + "\u4e2a\u7ea2\u5305\uff0c\u660e\u5e74\u4eba\u54c1\u5927\u7206\u53d1\uff01\u4f60\u6765\u8bd5\u8bd5\uff1f";
            // ih5game.stop().setShare({
            //     desc: a
            // }).setScore(d.score); /*a=XiaobinTool.createBitmapByName("qq_btn_png");this.addChild(a);a.x=b.x;a.y=b.y+b.height+12;a.addEventListener(egret.TouchEvent.TOUCH_BEGIN,this.doQQ,this);a.touchEnabled=!0;*/
            var c = XiaobinTool.createBitmapByName("replay_btn_png");
            this.addChild(c);
            c.x = b.x;
            c.y = b.y + b.height + 12;
            c.addEventListener(egret.TouchEvent.TOUCH_BEGIN, this.doReplay,
                this);
            c.touchEnabled = !0
        };
        d.prototype.doQQ = function(b) {
            location.href = window.qqUrl || "http://mp.weixin.qq.com/s?__biz=MzAwODE2MzEwMQ==&mid=203046773&idx=1&sn=7995098898f358d800fd7b27b2533943#rd"
        };
        d.prototype.doShare = function(b) {
            // ih5game.share()
        };
...
var __extends = this.__extends || function(b, d) {
    ...
    HomePage = function(b) {
        ...
        d.prototype.startGame = function(b) {
            ...
            this.stageW = this.stage.stageWidth;
            this.stageH = this.stage.stageHeight;
            b = XiaobinTool.createBitmapByName("logo_png");
            this.addChild(b);
            b.x = this.stageW / 2 - b.width / 2;
            b.y = this.stageH - b.height;
            b.touchEnabled = !0;
            b.addEventListener(egret.TouchEvent.TOUCH_END, this.onLogoTap, this);
            null == this.homePage && (this.startBtn = new StartBtn, this.addChild(this.startBtn), this.startBtn.x = this.stageW / 2, this.startBtn.y = this.stageH - 60, this.startBtn.anchorOffsetX = this.startBtn.width / 2, this.startBtn.anchorOffsetY = this.startBtn.height, this.startBtn.touchEnabled = !0, this.startBtn.addEventListener(egret.TouchEvent.TOUCH_BEGIN,
                this.onTouchBegin, this), this.startBtn.addEventListener(egret.TouchEvent.TOUCH_END, this.onTouchEnd, this), this.addEventListener(egret.TouchEvent.TOUCH_END, this.thisEnd, this));
            this.touchEnabled = !0
        };
        d.prototype.onTouchBegin = function(b) {
            b.target.scaleX = b.target.scaleY = 0.95
        };
        d.prototype.thisEnd = function(b) {
        ...
        d.prototype.onLogoTap =
            function(b) {
                this.dispatchEvent(new egret.Event("click_logo", !0))
            };
        return d
    }(egret.Sprite);
...
var __extends = this.__extends || function(b, d) {
    ...
    InGame = function(b) {
        function d() {
            b.call(this);
            this.scoreNum = this.count = this.touchY = this.touchX = this.stageH = this.stageW = 0;
            this.timeNum = 10;
            this.iconArr = [];
            this.speedArr = [];
            this.addEventListener(egret.Event.ADDED_TO_STAGE, this.ats, this)
        ...
        d.prototype.ats = function(b) {
            ...
            this.stageH = this.stage.stageHeight;
            this.creatBg();
            this.creatIconContainer();
            this.creatBg2();
            this.creatBtn();
            this.creatBtnMc();
            this.creatSixScoreMc();
            this.creatSixScoreMc2();
            this.creatShou();
            this.creatMiao();
            this.creatTimer();
            this.tip2 = XiaobinTool.createBitmapByName("tip2_png");
            this.addChild(this.tip2);
            this.tip2.x = this.stageW / 2 - this.tip2.width / 2;
            this.tip2.y = this.stageH - this.tip2.height - 40;
            this.ge = XiaobinTool.createBitmapByName("ge_png");
            this.addChild(this.ge);
            this.ge.x = this.stageW / 2 + 50;
            this.ge.y = this.stageH - this.tip2.height - 110;
            this.tip =
                XiaobinTool.createBitmapByName("tip_png");
        ...
        d.prototype.creatTimer =
            function() {
                this.timer = new egret.Timer(1E3, 10);
                this.timer.addEventListener(egret.TimerEvent.TIMER, this.doTimer, this)
            };
        d.prototype.doTimer = function(b) {
            0 < this.timeNum && (this.timeNum -= 1, this.sixScoreMc2.setNum(this.timeNum));
            0 == this.timeNum && this.gameOver()
        };
        d.prototype.gameOver = function() {
            var b = new GameOverPanel;
            GameOverPanel.score = this.scoreNum;
            this.addChild(b);
            b.scaleX = b.scaleY = 0.1;
            b.x = this.stageW / 2;
            b.y = 0;
            b.alpha = 0;
            egret.Tween.get(b).wait(300).to({
                x: 0,
                y: 0,
                scaleX: 1,
                scaleY: 1,
                alpha: 1
            }, 1E3, egret.Ease.quadOut).call(this.moveOver,
                this);
            this.removeEventListener(egret.Event.ENTER_FRAME, this.loop, this);
            this.removeEventListener(egret.TouchEvent.TOUCH_BEGIN, this.onTouchBegin, this);
            this.stage.removeEventListener(egret.TouchEvent.TOUCH_END, this.onTouchEnd, this)
        };
        d.prototype.moveOver = function() {};
        d.prototype.creatMiao = function() {
            this.miao = XiaobinTool.createBitmapByName("miao_png");
            this.addChild(this.miao);
            this.miao.x = 510;
            this.miao.y = 110
        };
        d.prototype.creatShou = function() {
            this.shou = XiaobinTool.createBitmapByName("s1_png");
            this.addChild(this.shou)
        };
        d.prototype.creatSixScoreMc2 = function() {
            this.sixScoreMc2 = new ScoreSixMc;
            this.sixScoreMc2.theJSON = "numberText2_json";
            this.sixScoreMc2.thePNG = "numberText2_png";
            this.addChild(this.sixScoreMc2);
            this.sixScoreMc2.x = 240;
            this.sixScoreMc2.y = 140;
            this.sixScoreMc2.setNum(this.timeNum)
        };
        d.prototype.creatSixScoreMc = function() {
            this.sixScoreMc = new ScoreSixMc;
            this.addChild(this.sixScoreMc);
            this.sixScoreMc.x = 70;
            this.sixScoreMc.y = 840;
            this.sixScoreMc.setNum(this.scoreNum)
        };
        d.prototype.creatBtnMc = function() {
            var b = XiaobinTool.creatMovieClip("anniu_json",
                "anniu_png", "up");
            this.addChild(b);
            b.x = this.stageW / 2;
            b.y = this.btn.y + this.btn.height / 2 - 100;
            this.mc = b
        };
        d.prototype.creatBtn = function() {
            var b = XiaobinTool.createBitmapByName("btn_png");
            this.addChild(b);
            b.alpha = 0.01;
            b.width = 500;
            b.height = 500;
        ...
        d.prototype.loop = function(b) {
            this.count++;
            8 <= this.count && (this.count = 0, null == this.tip && this.makeIcon());
            null == this.tip && this.makeDrop()
        };
        d.prototype.makeDrop = function() {
            for (var b = 0; b < this.iconArr.length; b++) {
                var a = this.iconArr[b];
                a.y += this.speedArr[b];
                a.scaleX -= this.speedArr[b] / 150;
                a.rotation += this.speedArr[b] / 10; - 1 >= a.scaleX && (a.scaleX = 1);
                a.y > this.stageH + 100 && (this.s.removeChild(a), this.speedArr.splice(b, 1), this.iconArr.splice(b, 1))
            }
        };
        d.prototype.makeIcon = function() {
            var b = Math.random(),
                b = XiaobinTool.createBitmapByName(0.2 > b ? "icon1_png" : 0.5 > b ? "icon2_png" : 0.8 > b ? "icon3_png" : 0.9 > b ? "hong1_png" : "hong2_png");
            this.s.addChild(b);
            b.anchorOffsetX = b.width / 2;
            var a = 50 + Math.random() * (this.stageW - 100);
            b.x = a;
            this.iconArr.push(b);
            b = 4 + 10 * Math.random();
            this.speedArr.push(b)
        };
        d.prototype.onTouchEnd = function(b) {
        ...
        d.prototype.onTouchBegin = function(b) {
            ...
            null != this.tip ? (this.removeChild(this.tip), this.tip = null, this.timer.start()) : this.btn.hitTestPoint(this.touchX, this.touchY) && (this.mc.gotoAndStop("down"), this.scoreNum++, this.sixScoreMc.setNum(this.scoreNum), this.removeChild(this.shou), this.shou = null, this.shou = 0 == this.scoreNum % 2 ? XiaobinTool.createBitmapByName("s2_png") :
                XiaobinTool.createBitmapByName("s1_png"), this.addChild(this.shou))
        };
        d.prototype.creatIconContainer = function() {
        ...
        d.prototype.creatBg2 = function() {
            this.bg2 = XiaobinTool.createBitmapByName("bg2_png");
...
var __extends = this.__extends || function(b, d) {
    ...
    Main = function(b) {
        ...
        d.prototype.createGameScene = function() {
            ...
            null == this.homepage && (this.homepage = new HomePage, this.homepage.addEventListener("click_logo", this.doMore, this));
        ...
        d.prototype.doReplay = function() {
            ...
            null == this.ingame && (this.ingame = new InGame,
                this.addChild(this.ingame))
        };
        d.prototype.doMore = function() {
            ih5game.more()
        };
