...
{
	window.loadingProgress = 1/_total * _current; 
      //var imgBar        = document.getElementById("GM4HTML5_loadingbar");
     //if (imgBar)
     //    imgBar.style.width = (480 / _total) * _current + "px";
...
//////////////////////  LOADING BAR SETTINGS ////////////////////////////////	
		var barwidth = (_width - 50) ;					//Loading bar width in pixel, use (_width / 100) * 50 to have a bar 50% width of screen
		...
		var y = 150 + (_height - barheight) / 2;		// Loading bar vertical position (in example moved 150px down from center)
		...
		var border_color= "rgb(45,45,45)";   			//Bar border color in rgb
		var bar_bg= "rgb(64,64,64)";   					//Bar Background color 
		var progress_bg= "rgb(255, 255, 255)";  			//Progress Bar color

///////////////////// BACKGROUND SETTINGS   ///////////////////////////////////
		var window_bgd="rgb(0,255,0)"; 				//Background color 
...
//////////////////// CUSTOM IMAGE SETTINGS TO BE USED INSTEAD OR TOGETHER GM:S LOADING SCREEN, LEAVE URL EMPTY IF NOT NEEDED	
		...
		customlogo.src = ""; 						//URL to custom image, leave empty in not needed
...
imgBar        = document.getElementById("GM4HTML5_loadingscreen");
    imgBar.style.display="none";
    imgBar.style.visibility="hidden";
    imgBar.style.pointerEvents = 'none';
