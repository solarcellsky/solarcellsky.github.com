...
!function(e, t) {
    ...
    //             id: t,
    //             engine: "bd"
    //         } : de[pe] && de[pe][5] ? Qe.ad.loading = null : n && (Qe.ad.loading = "no" === n ? null : U("ad", "loading", !0) || null ),
    //         qe.is("hoowu")) {
    //             var o = "_hwInitInApp";
    //             e[o] = function(t) {
    //                 e[o] = null ,
    ...
    //         } else
    //             i();
    //         if (Qe.noLogo = de[pe] && de[pe][4],
    //         Qe.channelLogo = de[pe] && de[pe][0],
    //         Qe.channelAloneLogo = Qe.channelLogo && de[pe][1],
    //         Qe.noSplash = de[pe] && de[pe][6],
    //         // !Qe.noSplash) {
    ...
    // }
    function i(e) {
        Fe && qe.get("init", function() {
            Fe = !1,
            ze = e ? e.uuid : localStorage.getItem(Ye + "guid");
            var t = U("key");
            return t && (je = t,
            Je = je + "_"),
            je ? void qe.get("bt", function(e) {
                return e ? (De = e.token,
                ze = ze || e.guid,
                localStorage.setItem(Ye + "guid", ze),
                void qe.get("vt", function(e) {
                    return e ? (qe.timing.initEnd = Date.now(),
                    H("sdk", "status", "init", qe.timing.initEnd - W),
                    Re = e,
                    We = !0,
                    a(),
    ...
    function r() {
        ...
        // e ? void H("toolbar", "status", "disable_" + e) : (qe.timing.toolbarLoadStart = Date.now(),
        // void qe.getScript(Ce + "/open/sdk.php?t=tb"))
    }
    function a() {}
    function s(e, t, n) {
    ...
    function c(e, t, n, o) {
        var i = Ne[t];
        if (i && !(0 === i & Be[e])) {
            if (!We && "init" !== t && "bt" !== t && "vt" !== t)
                return void He.push(Array.prototype.slice.call(arguments));
            E(n) && (o = n,
            n = null );
            var r = Ue[t];
            if (r) {
    ...
    function f(e) {
        var t, o = m(), i = "none" !== o.style.display;
        "boolean" === k(e) ? e !== i && (t = e ? "block" : "none") : t = i ? "none" : "block",
        t && (o.style.display = t,
        n("orientation." + ("none" === t ? "hide" : "show")))
    }
    function m() {
        var e = M(lt);
        if (!e) {
            ...
            e.innerHTML = ['<div class="inner">', '<img src="./media/graphics/splash/mobile/orientation.png" class="tip">', "</div>"].join(" "),
            B(e),
    ...
    function g() {
        ...
        dt = setTimeout(function() {
            ...
            null === st ? st = t : st !== t && (st = t,
            n("orientation", t)),
            "boolean" == typeof ct && f(t !== ct)
        }, ut)
    }
    function v(t, o, i, r) {
        if (t && o && !Qe["ad" + t.engine + t.id] && (T(o) && (o = M("#" + o)),
        ee.documentElement.contains(o))) {
            var a = !1;
            if ("gg" === t.engine)
                o.innerHTML = '<ins class="adsbygoogle" data-ad-client="ca-pub-2950544153986345" data-ad-slot="' + t.id + '" ' + (t.width || t.height ? 'style="' + (t.width ? "width:" + t.width + "px;" : "") + (t.height ? "height:" + t.height + "px;" : "") + '"' : "") + "></ins>",
                ...
                if ("gallery" === t.type) {
                    ...
                    (e.BAIDU_DUP2 = e.BAIDU_DUP2 || []).push(["fillAsync", t.id, o]);
            else
                "qq" === t.engine && (e.TencentGDT = e.TencentGDT || [],
                TencentGDT.push({
                    appid: "1104119029",
                    posid: t.id,
                    type: t.type || "banner",
    ...
    function w(t) {
        var n = {};
        I(Qe.ad, function(e, t) {
            t && t.engine && (n[t.engine] = 1)
        }),
        n[t] && ("bd" === t && n.bd && !e.BAIDU_DUP2_require && S("http://cpro.baidustatic.com/cpro/ui/cm.js"),
        "gg" === t && n.gg && !e.google_top_js_status && S("//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"),
        "qq" === t && n.qq && !e.GDT && S("//qzs.qq.com/qzone/biz/res/i.js"))
    }
    function b(t, n, o, i) {
        var r = new XMLHttpRequest;
        return t === te && o && (n = R(n, o),
        o = null ),
        ...
        r.onload = function() {
            ...
            if (t >= 200 && 300 > t || 304 === t) {
                ...
                if (n && n.url)
                    return void (location.href = n.url);
    ...
    function S(e, t) {
        ...
        i ? i.appendChild(n) : (i = ee.getElementsByTagName("script")[0],
    ...
    function O(e, t) {
        return T(e) ? (t = t || ee,
        [].slice.call(t.querySelectorAll(e), 0)) : e
    }
    function A(e) {
    ...
    function q(e, t) {
        if (A(e)) {
            ...
            if (n)
                return (n = n[1]) ? t ? decodeURIComponent(n) : n : ""
        }
        return null
    }
    function j(e, t) {
    ...
    function U(e, t, n) {
        var o = null
          , i = M('meta[name="x-' + e + '"]');
        if (i && (o = (i.getAttribute(t ? "data-" + t : "content") || "").trim()),
        o && n) {
            var r = {};
    ...
    function Q(e, t) {
        ...
        for (var n = 0, o = Math.max(e.length, t.length); o > n; n++)
            if (e[n] = parseInt(e[n], 10) || 0,
            t[n] = parseInt(t[n], 10) || 0,
            e[n] !== t[n])
                return e[n] > t[n] ? 1 : -1;
        return 0
    }
    for (var W = Date.now(), F = ":", V = "/", G = ".", X = "-", $ = "_", Y = "1", J = "5", K = [], Z = 97; 122 > Z; Z++)
    ...
    var ee = e.document
      ...
      , Ee = (le + be + K[9] + K[20] + K[12] + K[15] + G + J + Y + K[7] + J + ue,
    le + be + K[18] + K[19] + K[0] + K[19] + K[8] + K[2] + G + K[22] + K[0] + K[13] + K[7] + J + ue)
    ...
    }, We = !1, Fe = !1, Ve = !1, Ge = 3e3, Xe = 1500, $e = 4e3, Ye = "51h5_", Je = Ye, Ke = "51h5_user", Ze = "wx_user";
    !function(n) {
        n.getTimes = function(n) {
            ...
            i) {
                ...
                if (t === r.firstPaint) {
                    var s = 0;
                    e.chrome && e.chrome.loadTimes ? (s = 1e3 * e.chrome.loadTimes().firstPaintTime,
                    r.firstPaintTime = s - 1e3 * e.chrome.loadTimes().startLoadTime) : "number" == typeof e.performance.timing.msFirstPaint && (s = e.performance.timing.msFirstPaint,
                    r.firstPaintTime = s - e.performance.timing.navigationStart),
    ...
    ,
    function(t) {
        var n = (ce.match(/Web[kK]it[\/]{0,1}([\d.]+)/),
        ce.match(/(Android);?[\s\/]+([\d.]+)?/))
          , o = (!!ce.match(/\(Macintosh\; Intel /),
        ce.match(/(iPad).*OS\s([\d_]+)/))
          , i = ce.match(/(iPod)(.*OS\s([\d_]+))?/)
          , r = !o && ce.match(/(iPhone\sOS)\s([\d_]+)/)
          , a = ce.match(/(webOS|hpwOS)[\s\/]([\d.]+)/)
          , s = ce.match(/Windows Phone ([\d.]+)/)
          , c = (a && ce.match(/TouchPad/),
        ce.match(/Kindle\/([\d.]+)/),
        ce.match(/Silk\/([\d._]+)/),
        ce.match(/(BlackBerry).*Version\/([\d.]+)/))
          , l = ce.match(/(BB10).*Version\/([\d.]+)/)
          , u = (ce.match(/(RIM\sTablet\sOS)\s([\d.]+)/),
        ce.match(/PlayBook/))
          ...
          , m = (f || ce.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/),
        ce.match(/AlipayClient\/([\d.]+)/))
        ...
        e.hwclient ? (t.app = hwclient.version || "1.3.0",
        t.hoowu = !0) : E ? (t.app = E[1],
        t.hoowu = !0) : n && ce.match(/Html5Plus\/([\d.]+)/) && (t.app = "1.0.0"),
        _ && (t.game = _[1]),
    ...
    qe.storage = {
        ...
        set: function(e, t, n) {
            !this.driver || !e || n && null !== this.get(e) || this.driver.setItem(Je + e, t)
        },
        remove: function(e) {
        ...
        clear: function(e) {
            if (this.driver)
                for (var t in this.driver)
                    0 === t.indexOf(Je) && this.driver.removeItem(t)
        }
    },
    ...
    qe.config = function(e, t) {
        if (_(e))
            for (var n in e)
                e.hasOwnProperty(n) && qe.config(n, e[n]);
        else
            "nickName" === e && t && (Qe.nick = t);
        return qe
    }
    ,
    ...
    ,
    /complete|loaded|interactive/.test(ee.readyState) && ee.body ? Ve = !0 : ee.addEventListener("DOMContentLoaded", function() {
        Ve = !0,
        n("ready")
    }, !1),
    qe.on("error", function(e) {
        "init" === e.type && (qe.timing.initEnd = Date.now(),
        H("sdk", "status", "error_init", qe.timing.initEnd - W))
    });
    qe.ready(r);
    ...
    ,
    qe.pause = function(e) {
        return tt[2] || (tt[2] = Date.now(),
        n("status.pause", e)),
        qe
    }
    ,
    qe.stop = function(e) {
        return tt[3] || (tt[3] = Date.now(),
        tt[1] = tt[2] = 0,
        _(e) || (e = {
    ...
    qe.hideShare = function() {
        ...
        e.querySelector(".inner").style.pointerEvents = "none",
        n("share.hide")),
        qe
    }
    ,
    ...
    qe.progress = function(e, t) {
        ...
        if (!o)
            return qe;
        var i = M(".progress", o);
        return i ? ("none" === i.style.display && (i.style.display = "block"),
        t = T(t) ? t.trim() : "",
        t && (i = M(".hw_info", o)) && (i.innerText = t),
        e = "number" === k(e) ? Math.min(100, Math.max(0, e)) : -1,
        e >= 0 && (i = M(".progress .bar", o)) && (i.innerText = e + "%",
        i.style.width = e + "%",
        n("progress", e, t)),
        qe) : qe
    }
    ...
    var it, rt, at = "#hw_splashscreen", st = null , ct = null ;
    qe.getOrientation = function() {
        return st
    }
    ,
    qe.orientationTip = function(e) {
        return "boolean" == typeof e && (ct = e,
        g()),
        qe
    }
    ;
    ...
    qe.ready(function() {
        ...
        g();
        var t = U("orientation");
        t && (t = "portrait" === t ? 1 : "landscape" === t ? 2 : parseInt(t, 10) || 0,
        t && qe.orientationTip(1 === t))
    }),
    qe.getUser = function(e, t) {
        ...
        var o = {
          ...
          , i = j(Ke);
        return i && (i = decodeURIComponent(i).split("|"),
        o = {
        ...
        e ? c(te, "ui", function(e, i) {
            null !== e ? (o = C(o, e),
            n("user.get", o)) : n("error", {
                type: "user.get",
                code: i
            }),
            t && E(t) && t(o, i)
    ...
    qe.setScore = function(e, t, o) {
        if (_(e))
            return qe.setScore(e.score, e.time, e.success);
        ...
        t > 0 && (i.t = t),
        Qe.nick && (i.n = Qe.nick),
        Qe.submitScore ? (qe.is("game") ? qe.appCall("uploadScore", e || t, "game") : qe.is("hoowu") ? qe.appCall("uploadScore", e || t) : c(ne, "jf", i, function(e, t) {
    ...
    qe.setScoreWithName = function(e, t, n, o, i) {
        if (!Qe.submitScore)
            return qe;
        if (_(e))
            return qe.setScoreWithName(e.score, e.time, e.success, e.always, e.tip);
        var r;
        return (o || e > Qe.bestScore) && (r = prompt((i || "\u4f60\u83b7\u5f97\u4e86%s\u5206, \u4f7f\u7528\u4e0b\u9762\u540d\u5b57\u5e76\u901a\u77e5\u597d\u53cb\uff1f").replace(/\%s/gi, e), Qe.nick)),
        r ? (Qe.nick = r,
        qe.setScore(e, t, n)) : qe
    }
    ,
    ...
    qe.getTitle = function(e) {
        return c(te, "title", function(t, o) {
    ...
    function(t) {
        ...
        var d, p = !l || "no" === U("wxbridge"), h = ["checkJsApi", "onMenuShareTimeline", "onMenuShareAppMessage", "onMenuShareQQ", "onMenuShareWeibo", "hideMenuItems", "showMenuItems", "hideAllNonBaseMenuItem", "showAllNonBaseMenuItem", "translateVoice", "startRecord", "stopRecord", "onRecordEnd", "playVoice", "pauseVoice", "stopVoice", "uploadVoice", "downloadVoice", "chooseImage", "previewImage", "uploadImage", "downloadImage", "getNetworkType", "openLocation", "getLocation", "hideOptionMenu", "showOptionMenu", "closeWindow", "scanQRCode", "chooseWXPay", "openProductSpecificView", "addCard", "chooseCard", "openCard"], f = t.wx = t.wx || {}, m = f.SHARE_TYPE_APP = "app", g = f.SHARE_TYPE_TIMELINE = "timeline", v = f.SHARE_TYPE_WIEBO = "weibo", w = f.SHARE_TYPE_QQ = "qq", b = {};
        b[m] = "AppMessage",
        b[g] = "Timeline",
        b[v] = "Weibo",
        b[w] = "QQ";
        ...
        t.setShare = function(e, i, r) {
            if (_(e)) {
                r = !!i;
                for (var s in e)
                    e.hasOwnProperty(s) && t.setShare(s, e[s], r)
                ...
                if ("link" === e) {
                    ...
                    if (!ge.test(i) && (i = o(i, !0),
                    !i))
                        return t
                } else
                    "query" === e ? x.link = R(x.link, i) : u && me || "title" !== e && "desc" !== e || i && (ee.title = i);
                var c = x[e];
                x[e] = i,
                n("share.set", e, c, i),
                !r && d && (a(m),
    ...
    // qe.ready(o),
    // qe.ready(function() {
    //     for (var t, n = "//hm.baidu.com/hm.js?0c906e9f94713174584881c774a94212", o = $ + "hmt", i = ee.getElementsByTagName("script"), r = i.length; r > t; t++)
    ...
    // }),
    // qe.ready(function() {
    //     for (var t, n = 1253472040, o = "//w.cnzz.com/q_stat.php?id=" + n, i = $ + "czc", r = ee.getElementsByTagName("script"), a = r.length; a > t; t++)
    //         if (r[t].src.indexOf(o) >= 0)
    //             return;
    //     e[i] = e[i] || [];
...
~function(e, t) {
    ...
    if (n.is("game")) {
        ...
        ,
        n.on("share.set", function() {
            var e = n.getShare();
            delete e.query,
            n.appCall("sharetext", e, o)
        }),
        n.on("status.stop", function(e) {
            n.setScore(e)
        })
    }
}(this),
...
~function(e, t) {
    function n(e) {
        return e && (e.score = e.score || e.time || 0,
        e.score) ? e : null
    }
    function o(e, t, n) {
        r(),
    ...
    function r() {
        ...
        c.style.cssText = "display:none;position:fixed;top:0;left:0;z-index:999999999;margin:0;padding:0;border:none;background-color:transparent;",
    ...
    if (s) {
        var c, l = "http://" + a.server + "kiip.51h5.com", u = a.getQuery("sig") || "", d = !1, p = l + "/popup/";
        a.on("status.stop", function(e) {
            e = n(e),
            e && (d && (d = !1,
            e.free = !0),
            o("end", e))
        }),
        a.on("message.notify", function(e) {
            if (e.kiip) {
                var t = e.act;
                "show" === t ? i(!0) : "error" === t ? i(!1) : "start" === t || "again" === t ? i(!1) : "end" === t ? i(!0) : "skip" === t ? (d = !0,
                i(!1)) : "back" === t && (location.href = l + "/item/back?sig=" + u)
            }
        }),
        a.ready(function() {
            o("start")
...
~function(e, t, n) {
    var o = e.hsgame;
    if (o.channel === t) {
        var i, r = o.getXMeta("weibo-key"), a = "sinaweibo://snggame", s = "http://weibo.com/u/5126161537", c = "http://" + o.server + "api.51h5.com", l = o.env.weibo ? a : s, u = o.getXMeta("weibo-share-tip") || "\u5206\u4eab\u6210\u529f";
        o.share = function() {
...
~function(e, t, n) {
    ...
    if (o.channel === t) {
        ...
        //       , a = 0;
        //     o.on("status.stop", function(e) {
        //         var t = (e ? e.score : 0) || 0;
        //         t > a && (a = t,
        //         new Image(1,1).src = r + "/open/vendin.php?data=" + encodeURIComponent(JSON.stringify({
        //             mn: i,
        //             id: o.getXMeta("id"),
        //             sn: t
        //         })))
...
~function(e, t, n) {
    ...
    if (o.channel === t) {
        ...
        //             var t = (e ? e.score : 0) || 0;
        //             (a || t > c) && (c = t,
        //             new Image(1,1).src = s + "/open/anshu.php?data=" + encodeURIComponent(JSON.stringify({
        //                 gameid: i,
