...
function isQzone(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/qzone/i) == 'qzone'){return true;}else{return false;}}

function isQQ(){var ua = window.navigator.userAgent.toLowerCase();if(ua.match(/qq/i) == 'qq'){return true;}else{return false;}}
