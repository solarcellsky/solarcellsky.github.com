var MyLoaderScene = cc.Scene.extend({
    ...
    init : function(){
        ...
        var img = self._img = new cc.Sprite(res.loading_png);
        img.setPosition(cc.pAdd(cc.visibleRect.center, cc.p(-150, 0)));
        img.setColor(cc.color(180, 180, 180));
        bgLayer.addChild(this._img, 10);
