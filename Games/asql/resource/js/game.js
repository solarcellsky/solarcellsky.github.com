...
function g() {
	...
	ih5game.stop({"score":r});
	aa.innerHTML =  "<div style='color: #629654;margin-top: 50px;font-size: 22px;font-weight: bold;font-family: '微软雅黑';'>我刚刚在游戏中<br><span style='font-size: 30px;font-weight: bolder;'>摁死了"+r+"对情侣！</span></div>" ;
...
(new Image).src = "resource/images/share_tip.png";
var ha = 114,
	ea =
	152,
...
var h = new createjs.LoadQueue(!1, "resource/images/game/");
h.loadManifest(K);
