...
cc.path={join:function(){for(var a=arguments.length,c="",b=0;b<a;b++)c=(c+(""===c?"":"/")+arguments[b]).replace(/(\/|\\\\)$/,"");"undefined"!=typeof g_version&&(c+=(0>c.indexOf("?")?"?":"\x26")+"t\x3d"+g_version);return c},extname:function(a){return 0<=a.indexOf("file_type\x3d")?(a=/[\?\&]file_type=([^\&]+)/i.exec(a))?"."+a[1]:null:(a=/(\.[^\.\/\?\\]*)(\?.*)?$/.exec(a))?a[1]:null},mainFileName:function(a){if(a){var c=a.lastIndexOf(".");if(-1!==c)return a.substring(0,c)}return a},basename:function(a,
c){var b=a.indexOf("?");0<b&&(a=a.substring(0,b));b=/(\/|\\\\)([^(\/|\\\\)]+)$/g.exec(a.replace(/(\/|\\\\)$/,""));if(!b)return null;b=b[2];return c&&a.substring(a.length-c.length).toLowerCase()===c.toLowerCase()?b.substring(0,b.length-c.length):b},dirname:function(a){return a.replace(/((.*)(\/|\\|\\\\))?(.*?\..*$)?/,"$2")},changeExtname:function(a,c){c=c||"";var b=a.indexOf("?"),d="";0<b&&(d=a.substring(b),a=a.substring(0,b));b=a.lastIndexOf(".");return 0>b?a+c+d:a.substring(0,b)+c+d},changeBasename:function(a,
c,b,d){if(0===c.indexOf("."))return this.changeExtname(a,c);var e;d||(e=a.indexOf("?"));d="";b=b?this.extname(a):"";0<e&&(d=a.substring(e),a=a.substring(0,e));e=a.lastIndexOf("/");return a.substring(0,0>=e?0:e+1)+c+b+d}};
cc.loader={_jsCache:{},_register:{},_langPathCache:{},_aliases:{},resPath:"",audioPath:"",cache:{},getXMLHttpRequest:function(a){return a?new window.XDomainRequest:window.XMLHttpRequest?new window.XMLHttpRequest:new ActiveXObject("MSXML2.XMLHTTP")},_getArgs4Js:function(a){var c=a[0],b=a[1],d=a[2],e=["",null,null];if(1===a.length)e[1]=c instanceof Array?c:[c];else if(2===a.length)"function"===typeof b?(e[1]=c instanceof Array?c:[c],e[2]=b):(e[0]=c||"",e[1]=b instanceof Array?b:[b]);else if(3===a.length)e[0]=
c||"",e[1]=b instanceof Array?b:[b],e[2]=d;else throw"arguments error to load js!";return e},loadJs:function(a,c,b){var d=this,e=d._jsCache,f=d._getArgs4Js(arguments),g=f[0],h=f[1],f=f[2];-1<navigator.userAgent.indexOf("Trident/5")?d._loadJs4Dependency(g,h,0,f):cc.async.map(h,function(a,c,b){a=cc.path.join(g,a);if(e[a])return b(null);d._createScript(a,!1,b)},f)},loadJsWithImg:function(a,c,b){var d=this._loadJsImg(),e=this._getArgs4Js(arguments);this.loadJs(e[0],e[1],function(a){if(a)throw a;d.parentNode.removeChild(d);
...
_loadJs4Dependency:function(a,c,b,d){if(b>=c.length)d&&d();else{var e=this;e._createScript(cc.path.join(a,c[b]),!1,function(f){if(f)return d(f);e._loadJs4Dependency(a,c,b+1,d)})}},_loadJsImg:function(){var a=document,c=a.getElementById("cocos2d_loadJsImg");if(!c){c=cc.newElement("img");cc._loadingImage&&(c.src=cc._loadingImage);a=a.getElementById(cc.game.config.id);a.style.backgroundColor="black";a.parentNode.appendChild(c);var b=getComputedStyle?getComputedStyle(a):a.currentStyle;b||(b={width:a.width,
height:a.height});c.style.left=a.offsetLeft+(parseFloat(b.width)-c.width)/2+"px";c.style.top=a.offsetTop+(parseFloat(b.height)-c.height)/2+"px";c.style.position="absolute"}return c},loadTxt:function(a,c){if(cc._isNodeJs)require("fs").readFile(a,function(a,b){a?c(a):c(null,b.toString())});else{var b=!1;cc.sys.isIE9&&(0==a.indexOf("http")||0==a.indexOf("//"))&&0>a.indexOf(location.host)&&(b=!0);var d=this.getXMLHttpRequest(b),e="load "+a+" failed!";d.open("GET",a,!0);/msie/i.test(navigator.userAgent)&&
!/opera/i.test(navigator.userAgent)?b?d.onload=function(){d.responseText&&c(null,d.responseText)}:d.onreadystatechange=function(){4===d.readyState&&(200===d.status?c(null,d.responseText):c(e))}:(d.overrideMimeType&&d.overrideMimeType("text/plain; charset\x3dutf-8"),d.onload=function(){4===d.readyState&&(200===d.status?c(null,d.responseText):c(e))});d.send(null)}},_loadTxtSync:function(a){if(cc._isNodeJs)return require("fs").readFileSync(a).toString();var c=this.getXMLHttpRequest();c.open("GET",a,
!1);/msie/i.test(navigator.userAgent)&&!/opera/i.test(navigator.userAgent)?c.setRequestHeader("Accept-Charset","utf-8"):c.overrideMimeType&&c.overrideMimeType("text/plain; charset\x3dutf-8");c.send(null);return 4===!c.readyState||200!==c.status?null:c.responseText},loadCsb:function(a,c){var b=new XMLHttpRequest;b.open("GET",a,!0);b.responseType="arraybuffer";b.onload=function(){var d=b.response;d&&(window.msg=d);4===b.readyState&&(200===b.status?c(null,b.response):c("load "+a+" failed!"))};b.send(null)},
loadJson:function(a,c){this.loadTxt(a,function(b,d){if(b)c(b);else{try{var e=JSON.parse(d)}catch(f){throw"parse json ["+a+"] failed : "+f;}c(null,e)}})},_checkIsImageURL:function(a){return null!=/(\.png)|(\.jpg)|(\.bmp)|(\.jpeg)|(\.gif)/.exec(a)},loadImg:function(a,c,b){var d={isCrossOrigin:!0};void 0!==b?d.isCrossOrigin=null===c.isCrossOrigin?d.isCrossOrigin:c.isCrossOrigin:void 0!==c&&(b=c);var e=this.getRes(a);if(e)return b&&b(null,e),e;e=new Image;d.isCrossOrigin&&"file://"!==location.origin&&
(e.crossOrigin="Anonymous");var f=function(){this.removeEventListener("load",f,!1);this.removeEventListener("error",h,!1);b&&b(null,e)},g=this,h=function(){this.removeEventListener("error",h,!1);e.crossOrigin&&"anonymous"===e.crossOrigin.toLowerCase()?(d.isCrossOrigin=!1,g.release(a),cc.loader.loadImg(a,d,b)):"function"===typeof b&&b("load image failed")};cc._addEventListener(e,"load",f);cc._addEventListener(e,"error",h);e.src=a;return e},_loadResIterator:function(a,c,b){var d=this,e=null,f=a.type;
f?(f="."+f.toLowerCase(),e=a.src?a.src:a.name+f):(e=a,f=cc.path.extname(e));if(c=d.getRes(e))return b(null,c);c=null;f&&(c=d._register[f.toLowerCase()]);if(!c)return cc.error("loader for ["+f+"] not exists!"),b();f=e;cc._urlRegExp.test(e)||(f=c.getBasePath?c.getBasePath():d.resPath,f=d.getUrl(f,e));cc.game.config.noCache&&"string"===typeof f&&(f=d._noCacheRex.test(f)?f+("\x26_t\x3d"+(new Date-0)):f+("?_t\x3d"+(new Date-0)));c.load(f,e,a,function(a,c){a?(cc.log(a),d.cache[e]=null,delete d.cache[e],
b()):(d.cache[e]=c,b(null,c))})},_noCacheRex:/\?/,getUrl:function(a,c){var b=this._langPathCache,d=cc.path;if(void 0!==a&&void 0===c){c=a;var e=d.extname(c),e=e?e.toLowerCase():"";a=(e=this._register[e])?e.getBasePath?e.getBasePath():this.resPath:this.resPath}c=cc.path.join(a||"",c);if(c.match(/[\/(\\\\)]lang[\/(\\\\)]/i)){if(b[c])return b[c];d=d.extname(c)||"";c=b[c]=c.substring(0,c.length-d.length)+"_"+cc.sys.language+d}return c},load:function(a,c,b){var d=this,e=arguments.length;if(0===e)throw"arguments error!";
3===e?"function"===typeof c&&(c="function"===typeof b?{trigger:c,cb:b}:{cb:c,cbTarget:b}):2===e?"function"===typeof c&&(c={cb:c}):1===e&&(c={});a instanceof Array||(a=[a]);e=new cc.AsyncPool(a,0,function(a,b,e,k){d._loadResIterator(a,b,function(a){if(a)return e(a);var b=Array.prototype.slice.call(arguments,1);c.trigger&&c.trigger.call(c.triggerTarget,b[0],k.size,k.finishedSize);e(null,b[0])})},c.cb,c.cbTarget);e.flow();return e},_handleAliases:function(a,c){var b=this._aliases,d=[],e;for(e in a){var f=
a[e];b[e]=f;d.push(f)}this.load(d,c)},loadAliases:function(a,c){var b=this,d=b.getRes(a);d?b._handleAliases(d.filenames,c):b.load(a,function(a,d){b._handleAliases(d[0].filenames,c)})},register:function(a,c){if(a&&c){if("string"===typeof a)return this._register[a.trim().toLowerCase()]=c;for(var b=0,d=a.length;b<d;b++)this._register["."+a[b].trim().toLowerCase()]=c}},getRes:function(a){return this.cache[a]||this.cache[this._aliases[a]]},release:function(a){var c=this.cache,b=this._aliases;delete c[a];
delete c[b[a]];delete b[a]},releaseAll:function(){var a=this.cache,c=this._aliases,b;for(b in a)delete a[b];for(b in c)delete c[b]}};cc.formatStr=function(){var a=arguments,c=a.length;if(1>c)return"";var b=a[0],d=!0;"object"===typeof b&&(d=!1);for(var e=1;e<c;++e){var f=a[e];if(d)for(;;){var g=null;if("number"===typeof f&&(g=b.match(/(%d)|(%s)/))){b=b.replace(/(%d)|(%s)/,f);break}b=(g=b.match(/%s/))?b.replace(/%s/,f):b+("    "+f);break}else b+="    "+f}return b};
...
!1}try{var p=b.localStorage=d.localStorage;p.setItem("storage","");p.removeItem("storage");p=null}catch(s){p=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},b.localStorage={getItem:p,setItem:p,removeItem:p,clear:p}}p=b.capabilities={canvas:!0};cc._renderType===cc._RENDER_TYPE_WEBGL&&(p.opengl=!0);if(void 0!==g.ontouchstart||void 0!==f.ontouchstart||e.msPointerEnabled)p.touches=!0;void 0!==g.onmouseup&&(p.mouse=!0);void 0!==g.onkeyup&&(p.keyboard=
!0);if(d.DeviceMotionEvent||d.DeviceOrientationEvent)p.accelerometer=!0;b.garbageCollect=function(){};b.dumpRoot=function(){};b.restartVM=function(){};b.cleanScript=function(a){};b.isObjectValid=function(a){return a?!0:!1};b.dump=function(){var a;a=""+("isMobile : "+this.isMobile+"\r\n");a+="language : "+this.language+"\r\n";a+="browserType : "+this.browserType+"\r\n";a+="capabilities : "+JSON.stringify(this.capabilities)+"\r\n";a+="os : "+this.os+"\r\n";a+="platform : "+this.platform+"\r\n";cc.log(a)};
...
a.addClass("gameCanvas");a.setAttribute("width",c||480);a.setAttribute("height",b||320);a.setAttribute("tabindex",99);a.style.outline="none";e=f.style;e.width=(c||480)+"px";e.height=(b||320)+"px";e.margin="0 auto";e.overflow="hidden";f.top="100%";cc._renderType===cc._RENDER_TYPE_WEBGL&&(cc._renderContext=cc.webglContext=cc.create3DContext(a,{stencil:!0,preserveDrawingBuffer:!0,antialias:!cc.sys.isMobile,alpha:!1}));cc._renderContext?(d.gl=cc._renderContext,cc._drawingUtil=new cc.DrawingPrimitiveWebGL(cc._renderContext),
...
(c[a.debugMode]=0);c[a.frameRate]=c[a.frameRate]||60;null==c[a.renderMode]&&(c[a.renderMode]=1);return c};if(document.ccConfig)this.config=c(document.ccConfig);else try{cc.loader.resPath="undefined"!=typeof hoowuGame?hoowuGame.resRootDir:"";for(var b=document.getElementsByTagName("script"),d=0;d<b.length;d++){var e=b[d].getAttribute("cocos");if(""===e||e)break}var f,g,h;if(d<b.length){if(f=b[d].src)h=/(.*)\//.exec(f)[0],cc.loader.resPath=h,f=cc.path.join(h,"project.js");g=cc.loader._loadTxtSync(f)}g||
(g="undefined"!=typeof g_project?g_project:cc.loader._loadTxtSync(cc.path.join(cc.loader.resPath,"project.js")));var k=JSON.parse(g);this.config=c(k||{})}catch(m){cc.log("Failed to read or parse project.json"),this.config=c({})}cc._initSys(this.config,a)},_jsAddedCache:{},_getJsListOfModule:function(a,c,b){var d=this._jsAddedCache;if(d[c])return null;b=b||"";var e=[],f=a[c];if(!f)throw"can not find module ["+c+"]";c=cc.path;for(var g=0,h=f.length;g<h;g++){var k=f[g];if(!d[k]){var m=c.extname(k);m?
".js"===m.toLowerCase()&&e.push(c.join(b,k)):(m=this._getJsListOfModule(a,k,b))&&(e=e.concat(m));d[k]=1}}return e},prepare:function(a){var c=this,b=c.config,d=c.CONFIG_KEY,e=b[d.engineDir],f=cc.loader;if(!cc._supportRender)throw"The renderer doesn't support the renderMode "+b[d.renderMode];c._prepareCalled=!0;var g=b[d.jsList]||[];cc.Class?f.loadJsWithImg("",g,function(b){if(b)throw b;c._prepared=!0;a&&a()}):(d=cc.path.join(e,"moduleConfig.json"),f.loadJson(d,function(d,f){if(d)throw d;var m=b.modules||
[],n=f.module,p=[];cc._renderType===cc._RENDER_TYPE_WEBGL?m.splice(0,0,"shaders"):0>m.indexOf("core")&&m.splice(0,0,"core");for(var s=0,r=m.length;s<r;s++){var t=c._getJsListOfModule(n,m[s],e);t&&(p=p.concat(t))}p=p.concat(g);cc.loader.loadJsWithImg(p,function(b){if(b)throw b;c._prepared=!0;a&&a()})}))}};cc.game._initConfig();
...
Object.defineProperty(d.prototype,"constructor",h);this.__getters__&&(d.__getters__=cc.clone(this.__getters__));this.__setters__&&(d.__setters__=cc.clone(this.__setters__));for(var k=0,m=arguments.length;k<m;++k){var n=arguments[k],p;for(p in n){var s="function"===typeof n[p],r="function"===typeof e[p],t=a.test(n[p]);c&&s&&r&&t?(h.value=ClassManager.compileSuper(n[p],p,g),Object.defineProperty(f,p,h)):s&&r&&t?(h.value=function(a,c){return function(){var b=this._super;this._super=e[a];var d=c.apply(this,
arguments);this._super=b;return d}}(p,n[p]),Object.defineProperty(f,p,h)):s?(h.value=n[p],Object.defineProperty(f,p,h)):f[p]=n[p];if(s){var q,u;if(this.__getters__&&this.__getters__[p]){var s=this.__getters__[p],v;for(v in this.__setters__)if(this.__setters__[v]===s){u=v;break}cc.defineGetterSetter(f,s,n[p],n[u]?n[u]:f[u],p,u)}if(this.__setters__&&this.__setters__[p]){s=this.__setters__[p];for(v in this.__getters__)if(this.__getters__[v]===s){q=v;break}cc.defineGetterSetter(f,s,n[q]?n[q]:f[q],n[p],
q,p)}}}}d.extend=cc.Class.extend;d.implement=function(a){for(var c in a)f[c]=a[c]};return d}})();
...
cc._binaryLoader={load:function(a,c,b,d){cc.loader.loadBinary(a,d)}};cc._csbLoader={load:function(a,c,b,d){cc.loader.loadCsb(a,d)}};cc.loader.register(["csb"],cc._csbLoader);window.CocosEngine=cc.ENGINE_VERSION="Cocos2d-JS v3.7";cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL=0;cc.DIRECTOR_STATS_POSITION=cc.p(0,0);cc.DIRECTOR_FPS_INTERVAL=0.5;cc.COCOSNODE_RENDER_SUBPIXEL=1;cc.SPRITEBATCHNODE_RENDER_SUBPIXEL=1;cc.OPTIMIZE_BLEND_FUNC_FOR_PREMULTIPLIED_ALPHA=1;cc.TEXTURE_ATLAS_USE_TRIANGLE_STRIP=0;cc.TEXTURE_ATLAS_USE_VAO=0;cc.TEXTURE_NPOT_SUPPORT=0;cc.RETINA_DISPLAY_SUPPORT=1;cc.RETINA_DISPLAY_FILENAME_SUFFIX="-hd";cc.USE_LA88_LABELS=1;cc.SPRITE_DEBUG_DRAW=0;
...
cc.ContainerStrategy=cc.Class.extend({preApply:function(a){},apply:function(a,c){},postApply:function(a){},_setupContainer:function(a,c,b){var d=a._frame;cc.view._autoFullScreen&&cc.sys.isMobile&&d===document.documentElement&&cc.screen.autoFullScreen(d);var d=cc._canvas,e=cc.container;e.style.width=d.style.width=c+"px";e.style.height=d.style.height=b+"px";a._devicePixelRatio=1;a.isRetinaEnabled()&&(a._devicePixelRatio=window.devicePixelRatio||1);d.width=640;d.height=b/c*640;a._devicePixelRatio=640/
c;cc._renderContext.resetCache&&cc._renderContext.resetCache();a=document.body;var f;a&&(f=a.style)&&(f.paddingTop=f.paddingTop||"0px",f.paddingRight=f.paddingRight||"0px",f.paddingBottom=f.paddingBottom||"0px",f.paddingLeft=f.paddingLeft||"0px",f.borderTop=f.borderTop||"0px",f.borderRight=f.borderRight||"0px",f.borderBottom=f.borderBottom||"0px",f.borderLeft=f.borderLeft||"0px",f.marginTop=f.marginTop||"0px",f.marginRight=f.marginRight||"0px",f.marginBottom=f.marginBottom||"0px",f.marginLeft=f.marginLeft||
"0px")},_fixContainer:function(){document.body.insertBefore(cc.container,document.body.firstChild);var a=document.body.style;a.width=window.innerWidth+"px";a.height=window.innerHeight+"px";a.overflow="hidden";a=cc.container.style;a.position="fixed";a.left=a.top="0px";document.body.scrollTop=0}});
...
c){var b=cc._canvas.width,d=cc._canvas.height;return this._buildResult(b,d,b,d,b/c.width,d/c.height)}}),c=cc.ContentStrategy.extend({apply:function(a,c){var b=cc._canvas.width,d=cc._canvas.height,e=c.width,n=c.height,p=b/e,s=d/n,r=0,t,q;p<s?(r=p,t=b,q=n*r):(r=s,t=e*r,q=d);return this._buildResult(b,d,t,q,r,r)}}),b=cc.ContentStrategy.extend({apply:function(a,c){var b=cc._canvas.width,d=cc._canvas.height,e=c.width,n=c.height,p=b/e,s=d/n,r,t,q;p<s?(r=s,t=e*r,q=d):(r=p,t=b,q=n*r);return this._buildResult(b,
...
cc.pSubIn=function(a,c){a.x-=c.x;a.y-=c.y};cc.pAddIn=function(a,c){a.x+=c.x;a.y+=c.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,c,b,d,e){e+=d;if(!(1>=e)){c*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var n=cc.p(a[2*(h+1)],a[2*(h+1)+1]),p=cc.pNormalize(cc.pSub(n,k)),s=cc.pNormalize(cc.pSub(m,k)),r=Math.acos(cc.pDot(p,s));m=r<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(p,
s))):r<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(p,s)):cc.pPerp(cc.pNormalize(cc.pSub(n,m)))}m=cc.pMult(m,c);b[2*f]=k.x+m.x;b[2*f+1]=k.y+m.y;b[2*(f+1)]=k.x-m.x;b[2*(f+1)+1]=k.y-m.y}for(h=0===d?0:d-1;h<g;h++)f=2*h,a=f+2,c=cc.vertex2(b[2*f],b[2*f+1]),e=cc.vertex2(b[2*(f+1)],b[2*(f+1)+1]),f=cc.vertex2(b[2*a],b[2*a]),d=cc.vertex2(b[2*(a+1)],b[2*(a+1)+1]),c=!cc.vertexLineIntersect(c.x,c.y,d.x,d.y,e.x,e.y,f.x,f.y),!c.isSuccess&&(0>c.value||1<c.value)&&(c.isSuccess=!0),c.isSuccess&&(b[2*a]=d.x,
...
g||(8<=m?k=d.PIXEL_FORMAT_RGB888:(cc.log(cc._LogInfos.Texture2D__initPremultipliedATextureWithImage),k=d.PIXEL_FORMAT_RGB565));var n=c*b;if(k===d.PIXEL_FORMAT_RGB565)if(g)for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<n;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>2<<5|(f[m]>>16&255)>>3<<0;else for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<n;++m)e[m]=(f[m]&255)>>3<<11|(f[m]&255)>>2<<5|(f[m]&255)>>3<<0;else if(k===d.PIXEL_FORMAT_RGBA4444)for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<n;++m)e[m]=(f[m]>>
0&255)>>4<<12|(f[m]>>8&255)>>4<<8|(f[m]>>16&255)>>4<<4|(f[m]>>24&255)>>4<<0;else if(k===d.PIXEL_FORMAT_RGB5A1)for(e=new Uint16Array(c*b),f=a.getData(),m=0;m<n;++m)e[m]=(f[m]>>0&255)>>3<<11|(f[m]>>8&255)>>3<<6|(f[m]>>16&255)>>3<<1|(f[m]>>24&255)>>7<<0;else if(k===d.PIXEL_FORMAT_A8)for(e=new Uint8Array(c*b),f=a.getData(),m=0;m<n;++m)e[m]=f>>24&255;if(g&&k===d.PIXEL_FORMAT_RGB888)for(f=a.getData(),e=new Uint8Array(c*b*3),m=0;m<n;++m)e[3*m]=f>>0&255,e[3*m+1]=f>>8&255,e[3*m+2]=f>>16&255;this.initWithData(e,
...
a._updateSquareVerticesHeight=function(){};a._bakeRendering=function(){if(this._cacheDirty){var a=this._node,b=this._bakeSprite,d=a._children,e=d.length;this.transform(this.getParentRenderCmd(),!0);var f=this._getBoundingBoxForBake();f.width=0|f.width+0.5;f.height=0|f.height+0.5;var g=b.getCacheContext(),h=g.getContext();b.resetCanvasSize(f.width,f.height);h.fillStyle=g._currentFillStyle;g.setOffset(0-f.x,h.canvas.height-f.height+f.y);b.setPosition(f.x,f.y);cc.renderer._turnToCacheMode(this.__instanceId);
if(0<e){a.sortAllChildren();for(a=0;a<e;a++)if(f=d[a],0>f._localZOrder)f._renderCmd.visit(this);else break;for(cc.renderer.pushRenderCommand(this);a<e;a++)d[a]._renderCmd.visit(this)}else cc.renderer.pushRenderCommand(this);cc.renderer._renderingToCacheCanvas(g,this.__instanceId);b.transform();this._cacheDirty=!1}};a.visit=function(a){this._isBaked?this._node._visible&&(this._syncStatus(a),cc.renderer.pushRenderCommand(this._bakeRenderCmd),this._bakeSprite._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty),
...
!0;var d=b.length,e=2*d,f,g=a._contentSize;this._squareVerticesAB=new ArrayBuffer(8*e);this._squareColorsAB=new ArrayBuffer(4*e);var h=this._squareVertices,k=this._squareColors;h.length=0;k.length=0;var m=this._squareVerticesAB,n=this._squareColorsAB,p=cc.Vertex2F.BYTES_PER_ELEMENT,s=cc.Color.BYTES_PER_ELEMENT;for(f=0;f<e;f++)h.push(new cc.Vertex2F(0,0,m,p*f)),k.push(cc.color(0,0,0,255,n,s*f));n=Math.PI+cc.pAngleSigned(cc.p(0,-1),a._alongVector);a=cc.p(g.width/2,g.height/2);f=Math.round(cc.radiansToDegrees(n));
e=cc.affineTransformMake(1,0,0,1,a.x,a.y);e=cc.affineTransformRotate(e,n);90>f?(p=cc.p(-a.x,a.y),f=cc.p(a.x,a.y)):180>f?(p=cc.p(a.x,a.y),f=cc.p(a.x,-a.y)):270>f?(p=cc.p(a.x,-a.y),f=cc.p(-a.x,-a.y)):(p=cc.p(-a.x,-a.y),f=cc.p(-a.x,a.y));m=Math.sin(n);n=Math.cos(n);p=Math.abs((p.x*n-p.y*m)/a.x);f=Math.abs((f.x*m+f.y*n)/a.y);e=cc.affineTransformScale(e,p,f);for(f=0;f<d;f++)m=b[f].p*g.height,n=cc.pointApplyAffineTransform(-a.x,m-a.y,e),h[2*f].x=n.x,h[2*f].y=n.y,m=cc.pointApplyAffineTransform(g.width-a.x,
...
cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor,e=a.width,h=a.height;d[0].width=e;d[0].height=h;d[1].width=e;d[1].height=h;d[2].width=e;d[2].height=h;d[3].width=e;d[3].height=h;b.canvas.width=e;b.canvas.height=h;var k=b.canvas.getContext("2d");k.drawImage(a,0,0);b.tempCanvas.width=e;b.tempCanvas.height=h;for(var k=k.getImageData(0,0,e,h).data,m=0;4>m;m++){var n=d[m].getContext("2d");n.getImageData(0,0,e,h).data;b.tempCtx.drawImage(a,0,0);for(var p=b.tempCtx.getImageData(0,0,e,h),s=p.data,
...
function(a){if(a){var b=this._node,d=b._strokeShadowOffsetX,e=b._strokeShadowOffsetY,f=b._contentSize.height-e,g=b._vAlignment,h=b._hAlignment,k=b._strokeSize;a.setTransform(1,0,0,1,0.5*d,f+0.5*e);a.font!==this._fontStyleStr&&(a.font=this._fontStyleStr);a.fillStyle=this._fillColorStr;var m=e=0,n=b._strokeEnabled;n&&(a.lineWidth=2*k,a.strokeStyle=this._strokeColorStr);b._shadowEnabled&&(k=b._shadowOffset,a.shadowColor=this._shadowColorStr,a.shadowOffsetX=k.x,a.shadowOffsetY=-k.y,a.shadowBlur=b._shadowBlur);
...
(m=g===cc.VERTICAL_TEXT_ALIGNMENT_TOP?m-f:m-0.5*f),n&&a.strokeText(b._string,e,m),a.fillText(b._string,e,m)}};a._checkWarp=function(a,b,d){var e=a[b],f=this._measure(e);if(f>d&&1<e.length){for(var g=d/f*e.length|0,h=e.substr(g),k=f-this._measure(h),m,n=0,p=0;k>d&&100>p++;)g*=d/k,g|=0,h=e.substr(g),k=f-this._measure(h);for(p=0;k<d&&100>p++;)h&&(n=(m=cc.LabelTTF._wordRex.exec(h))?m[0].length:1,m=h),g+=n,h=e.substr(g),k=f-this._measure(h);g-=n;0===g&&(g=1,m=m.substr(1));d=e.substr(0,g);cc.LabelTTF.wrapInspection&&
...
1));if(b.currentActionSalvaged)b.currentAction=null;else if(b.currentAction.isDone()){b.currentAction.stop();var e=b.currentAction;b.currentAction=null;this.removeAction(e)}b.currentAction=null}this._currentTargetSalvaged&&0===b.actions.length&&this._deleteHashElement(b)&&d--}}});cc.ACTION_TAG_INVALID=-1;
...
this._cloneDecoration(a);return a},easing:function(a){this._easeList?this._easeList.length=0:this._easeList=[];for(var c=0;c<arguments.length;c++)this._easeList.push(arguments[c]);return this},_computeEaseTime:function(a){var c=this._easeList;if(!c||0===c.length)return a;for(var b=0,d=c.length;b<d;b++)a=c[b].easing(a);return a},step:function(a){this._firstTick?(this._firstTick=!1,this._elapsed=0):this._elapsed+=a;a=this._elapsed/(1.192092896E-7<this._duration?this._duration:1.192092896E-7);a=1>a?
...
a);this._from=this.target.color},update:function(a){a=this._computeEaseTime(a);var c=this._from,b=this._to;c&&this.target.setColor(cc.color(c.r+(b.r-c.r)*a,c.g+(b.g-c.g)*a,c.b+(b.b-c.b)*a))}});cc.tintTo=function(a,c,b,d){return new cc.TintTo(a,c,b,d)};cc.TintTo.create=cc.tintTo;
...
1;u.connect(f.destination);q=new cc.Audio(f,u,b);a.manualLoop&&(q._manualLoop=!0)}catch(v){c=!1,cc.log("browser don't support webAudio"),q=new cc.Audio(null,null,b)}else q=new cc.Audio(null,null,b);this.loadAudioFromExtList(b,t,q,k);h.cache[d]=q},loadAudioFromExtList:function(b,d,g,k){if(0===d.length){var r="can not found the resource of audio! Last match url is : ",r=r+b.replace(/\.(.*)?$/,"(");e.forEach(function(a){r+=a+"|"});r=r.replace(/\|$/,")");return k(r)}b=cc.path.changeExtname(b,d.splice(0,
1));if(c){a.webAudioCallback&&a.webAudioCallback(b);var t=new XMLHttpRequest;t.open("GET",b,!0);t.responseType="arraybuffer";t.onload=function(){f.decodeAudioData(t.response,function(a){g.setBuffer(a);k(null,g)},function(){h.loadAudioFromExtList(b,d,g,k)})};t.send()}else{var q=document.createElement("audio"),u=!1,v=!1,w=setTimeout(function(){0===q.readyState?y():(v=!0,q.pause(),document.body.removeChild(q),k("audio load timeout : "+b,g))},1E4),x=function(){if(!u){q.pause();try{q.currentTime=0,q.volume=
1}catch(a){}document.body.removeChild(q);g.setElement(q);q.removeEventListener("canplaythrough",x,!1);q.removeEventListener("error",z,!1);q.removeEventListener("emptied",y,!1);!v&&k(null,g);u=!0;clearTimeout(w)}},z=function(){u&&(q.pause(),document.body.removeChild(q),q.removeEventListener("canplaythrough",x,!1),q.removeEventListener("error",z,!1),q.removeEventListener("emptied",y,!1),!v&&h.loadAudioFromExtList(b,d,g,k),u=!0,clearTimeout(w))},y=function(){v=!0;x();k(null,g)};cc._addEventListener(q,
"canplaythrough",x,!1);cc._addEventListener(q,"error",z,!1);a.emptied&&cc._addEventListener(q,"emptied",y,!1);q.src=b;document.body.appendChild(q);q.volume=0;q.play()}}};cc.loader.register(["mp3","ogg","wav","mp4","m4a"],h);cc.audioEngine={_currMusic:null,_musicVolume:1,willPlayMusic:function(){return!1},playMusic:function(a,c){var b=this._currMusic;b&&b.src!==a&&b.getPlaying()&&b.stop();b=h.cache[a];b||(cc.loader.load(a),b=h.cache[a]);b.play(0,c);b.setVolume(this._musicVolume);this._currMusic=b},
stopMusic:function(a){var c=this._currMusic;c&&(c.stop(),a&&cc.loader.release(c.src))},pauseMusic:function(){var a=this._currMusic;a&&a.pause()},resumeMusic:function(){var a=this._currMusic;a&&a.resume()},rewindMusic:function(){var a=this._currMusic;a&&(a.stop(),a.play())},getMusicVolume:function(){return this._musicVolume},setMusicVolume:function(a){a-=0;isNaN(a)&&(a=1);1<a&&(a=1);0>a&&(a=0);this._musicVolume=a;var c=this._currMusic;c&&c.setVolume(a)},isMusicPlaying:function(){var a=this._currMusic;
...
e.push(g)}return g},setEffectsVolume:function(a){a-=0;isNaN(a)&&(a=1);1<a&&(a=1);0>a&&(a=0);this._effectVolume=a;var c=this._audioPool,b;for(b in c){var d=c[b];if(Array.isArray(d))for(var e=0;e<d.length;e++)d[e].setVolume(a)}},getEffectsVolume:function(){return this._effectVolume},pauseEffect:function(a){a&&a.pause()},pauseAllEffects:function(){var a=this._audioPool,c;for(c in a)for(var b=a[c],d=0;d<a[c].length;d++)b[d].getPlaying()&&b[d].pause()},resumeEffect:function(a){a&&a.resume()},resumeAllEffects:function(){var a=
this._audioPool,c;for(c in a)for(var b=a[c],d=0;d<a[c].length;d++)b[d].resume()},stopEffect:function(a){a&&a.stop()},stopAllEffects:function(){var a=this._audioPool,c;for(c in a)for(var b=a[c],d=0;d<a[c].length;d++)b[d].stop()},unloadEffect:function(a){if(a){cc.loader.release(a);var c=this._audioPool[a];c&&(c.length=0);delete this._audioPool[a];delete h.cache[a]}},end:function(){this.stopMusic();this.stopAllEffects()},_pauseCache:[],_pausePlaying:function(){var a=this._currMusic;a&&a.getPlaying()&&
(a.pause(),this._pauseCache.push(a));var a=this._audioPool,c;for(c in a)for(var b=a[c],d=0;d<a[c].length;d++)b[d].getPlaying()&&(b[d].pause(),this._pauseCache.push(b[d]))},_resumePlaying:function(){for(var a=this._pauseCache,c=0;c<a.length;c++)a[c].resume();a.length=0}};if(!d){var k=function(){var c=cc.audioEngine._currMusic;c&&!1===c._touch&&c._playing&&c.getPlaying()&&(c._touch=!0,c.play(0,c.loop),!a.replay&&cc._canvas.removeEventListener("touchstart",k))};setTimeout(function(){cc._canvas&&cc._canvas.addEventListener("touchstart",
k,!1)},150)}cc.eventManager.addCustomListener(cc.game.EVENT_HIDE,function(){cc.audioEngine._pausePlaying()});cc.eventManager.addCustomListener(cc.game.EVENT_SHOW,function(){cc.audioEngine._resumePlaying()})})(cc.__audioSupport);cc.LabelAtlas=cc.AtlasNode.extend({_string:null,_mapStartChar:null,_textureLoaded:!1,_className:"LabelAtlas",ctor:function(a,c,b,d,e){cc.AtlasNode.prototype.ctor.call(this);this._renderCmd.setCascade();c&&cc.LabelAtlas.prototype.initWithString.call(this,a,c,b,d,e)},_createRenderCmd:function(){return cc._renderType===cc._RENDER_TYPE_WEBGL?new cc.LabelAtlas.WebGLRenderCmd(this):new cc.LabelAtlas.CanvasRenderCmd(this)},textureLoaded:function(){return this._textureLoaded},addLoadedEventListener:function(a,
...
(function(){var a=cc.LabelAtlas.prototype;cc.defineGetterSetter(a,"opacity",a.getOpacity,a.setOpacity);cc.defineGetterSetter(a,"color",a.getColor,a.setColor);cc.defineGetterSetter(a,"string",a.getString,a.setString)})();cc.LabelAtlas.create=function(a,c,b,d,e){return new cc.LabelAtlas(a,c,b,d,e)};(function(){cc.LabelAtlas.CanvasRenderCmd=function(a){cc.AtlasNode.CanvasRenderCmd.call(this,a);this._needDraw=!1};var a=cc.LabelAtlas.CanvasRenderCmd.prototype=Object.create(cc.AtlasNode.CanvasRenderCmd.prototype);a.constructor=cc.LabelAtlas.CanvasRenderCmd;a.setCascade=function(){var a=this._node;a._cascadeOpacityEnabled=!0;a._cascadeColorEnabled=!1};a.updateAtlasValues=function(){for(var a=this._node,b=a._string||"",d=b.length,e=this._texture,f=a._itemWidth,g=a._itemHeight,h=0,k=-1;h<d;h++){var m=
b.charCodeAt(h)-a._mapStartChar.charCodeAt(0),n=parseInt(m%a._itemsPerRow,10),m=parseInt(m/a._itemsPerRow,10);if(!(0>n||0>m)){k++;var n=cc.rect(n*f,m*g,f,g),m=b.charCodeAt(h),p=a.getChildByTag(h);p?32===m?(p.init(),p.setTextureRect(cc.rect(0,0,10,10),!1,cc.size(0,0))):(p.initWithTexture(e,n),p.visible=!0):(p=new cc.Sprite,32===m?(p.init(),p.setTextureRect(cc.rect(0,0,10,10),!1,cc.size(0,0))):p.initWithTexture(e,n),cc.Node.prototype.addChild.call(a,p,0,h));p.setPosition(k*f+f/2,g/2)}}};a.setString=
function(a){a=this._node;if(a._children){a=a._children;for(var b=a.length,d=0;d<b;d++){var e=a[d];e&&!e._lateChild&&(e.visible=!1)}}};a._addChild=function(){child._lateChild=!0}})();(function(){cc.LabelAtlas.WebGLRenderCmd=function(a){cc.AtlasNode.WebGLRenderCmd.call(this,a);this._needDraw=!0};var a=cc.LabelAtlas.WebGLRenderCmd.prototype=Object.create(cc.AtlasNode.WebGLRenderCmd.prototype);a.constructor=cc.LabelAtlas.WebGLRenderCmd;a.setCascade=function(){var a=this._node;a._cascadeOpacityEnabled=!0;a._cascadeColorEnabled=!0};a.rendering=function(a){cc.AtlasNode.WebGLRenderCmd.prototype.rendering.call(this,a);cc.LABELATLAS_DEBUG_DRAW&&(a=this._node.getContentSize(),a=[cc.p(0,
...
n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,s=0,r=-1;s<d;s++){var t=b.charCodeAt(s)-a._mapStartChar.charCodeAt(0),q=t%a._itemsPerRow,u=0|t/a._itemsPerRow;if(!(0>q||0>u)){r++;var v;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(q=(2*q*h+1)/(2*g),t=q+(2*h-2)/(2*g),u=(2*u*k+1)/(2*f),v=u+(2*k-2)/(2*f)):(q=q*h/g,t=q+h/g,u=u*k/f,v=u+k/f);var w=m[s],x=w.tl,z=w.tr,y=w.bl,w=w.br;x.texCoords.u=q;x.texCoords.v=u;z.texCoords.u=t;z.texCoords.v=u;y.texCoords.u=q;y.texCoords.v=v;w.texCoords.u=t;w.texCoords.v=
v;y.vertices.x=r*p;y.vertices.y=0;y.vertices.z=0;w.vertices.x=r*p+p;w.vertices.y=0;w.vertices.z=0;x.vertices.x=r*p;x.vertices.y=a._itemHeight;x.vertices.z=0;z.vertices.x=r*p+p;z.vertices.y=a._itemHeight;z.vertices.z=0;x.colors=n;z.colors=n;y.colors=n;w.colors=n}}0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.setString=function(a){a=a.length;a>this._textureAtlas.totalQuads&&this._textureAtlas.resizeCapacity(a)};a._addChild=function(){}})();cc.LABEL_AUTOMATIC_WIDTH=-1;
...
null==b?-1:b,this._realOpacity=255,this._realColor=cc.color(255,255,255,255),this._contentSize.width=0,this._contentSize.height=0,this.setAnchorPoint(0.5,0.5),this._renderCmd._initBatchTexture(),this.setString(a,!0),!0):!1},createFontChars:function(){var a=this._renderCmd._texture||this.textureAtlas.texture,c=0,b=cc.size(0,0),d=0,e=1,f=this._string,g=f?f.length:0;if(0!==g){var h,k=this._config,m=k.kerningDict,n=k.commonHeight,p=k.fontDefDictionary;for(h=0;h<g-1;h++)10===f.charCodeAt(h)&&e++;var s=
n*e,e=-(n-n*e),r=-1;for(h=0;h<g;h++)if(n=f.charCodeAt(h),0!==n)if(10===n)c=0,e-=k.commonHeight;else{var r=m[r<<16|n&65535]||0,t=p[n];t||(cc.log("cocos2d: LabelBMFont: character not found "+f[h]),t={rect:{x:0,y:0,width:0,height:0},xOffset:0,yOffset:0,xAdvance:0});var q=cc.rect(t.rect.x,t.rect.y,t.rect.width,t.rect.height),q=cc.rectPixelsToPoints(q);q.x+=this._imageOffset.x;q.y+=this._imageOffset.y;var u=this.getChildByTag(h);u?this._renderCmd._updateCharTexture(u,q,n):(u=new cc.Sprite,u.initWithTexture(a,
q,!1),u._newTextureWhenChangeColor=!0,this.addChild(u,0,h));u.opacityModifyRGB=this._opacityModifyRGB;this._renderCmd._updateCharColorAndOpacity(u);q=cc.p(c+t.xOffset+0.5*t.rect.width+r,e+(k.commonHeight-t.yOffset)-0.5*q.height*cc.contentScaleFactor());u.setPosition(cc.pointPixelsToPoints(q));c+=t.xAdvance+r;r=n;d<c&&(d=c)}b.width=t&&t.xAdvance<t.rect.width?d-t.xAdvance+t.rect.width:d;b.height=s;this.setContentSize(cc.sizePixelsToPoints(b))}},updateString:function(a){var c=this._children;if(c)for(var b=
0,d=c.length;b<d;b++){var e=c[b];e&&(e.visible=!1)}this._config&&this.createFontChars();a||this.updateLabel()},getString:function(){return this._initialString},setString:function(a,c){a=String(a);null==c&&(c=!0);null!=a&&cc.isString(a)||(a+="");this._initialString=a;this._setString(a,c)},_setStringForSetter:function(a){this.setString(a,!1)},setCString:function(a){this.setString(a,!0)},_getCharsWidth:function(a,c){if(0>=c)return 0;var b=this.getChildByTag(a),d=this.getChildByTag(a+c);return this._getLetterPosXLeft(d)-
this._getLetterPosXLeft(b)},_checkWarp:function(a,c,b,d){for(var e=a[c],f=0,g=0;g<c;g++)f+=a[g].length;var f=f+c-d,h=this._getCharsWidth(f,a[c].length-1);if(h>b&&1<e.length){d=b/h*e.length|0;for(var g=e.substr(d),k=h-this._getCharsWidth(f+d,g.length-1),m,n=0,p=0;k>b&&100>p++;)d*=b/k,d|=0,g=e.substr(d),k=h-this._getCharsWidth(f+d,g.length-1);for(p=0;k<b&&100>p++;)g&&(n=(m=cc.LabelTTF._wordRex.exec(g))?m[0].length:1,m=g),this._lineBreakWithoutSpaces&&(n=0),d+=n,g=e.substr(d),k=h-this._getCharsWidth(f+
d,g.length-1);d-=n;0===d&&(d=1,m=m.substr(1));b=e.substr(0,d);cc.LabelTTF.wrapInspection&&cc.LabelTTF._symbolRex.test(m||g)&&(n=(f=cc.LabelTTF._lastWordRex.exec(b))?f[0].length:0,this._lineBreakWithoutSpaces&&(n=0),d-=n,m=e.substr(d),b=e.substr(0,d));cc.LabelTTF._firsrEnglish.test(m)&&(f=cc.LabelTTF._lastEnglish.exec(b))&&b!==f[0]&&(n=f[0].length,this._lineBreakWithoutSpaces&&(n=0),d-=n,m=e.substr(d),b=e.substr(0,d));a[c]=m||g;a.splice(c,0,b)}},updateLabel:function(){this.string=this._initialString;
var a,c,b;if(0<this._width){var d=this.string.split("\n"),e="",f=0,g=0;for(a=0;a<d.length;a++)g=d.length,this._checkWarp(d,a,this._width*this._scaleX,f),g<d.length&&f++,0<a&&(e+="\n"),e+=d[a];e+=String.fromCharCode(0);this._setString(e,!1)}if(this._alignment!==cc.TEXT_ALIGNMENT_LEFT)for(d=a=0,e=this._string.length,f=[],g=0;g<e;g++)if(10===this._string[g].charCodeAt(0)||0===this._string[g].charCodeAt(0)){c=0;var h=f.length;if(0===h)d++;else if(b=a+h-1+d,!(0>b)){var k=this.getChildByTag(b);if(null!=
k){c=k.getPositionX()+k._getWidth()/2;k=0;switch(this._alignment){case cc.TEXT_ALIGNMENT_CENTER:k=this.width/2-c/2;break;case cc.TEXT_ALIGNMENT_RIGHT:k=this.width-c}if(0!==k)for(c=0;c<h;c++)b=a+c+d,0>b||(b=this.getChildByTag(b))&&(b.x+=k);a+=h;d++;f.length=0}}}else f.push(this._string[a])},setAlignment:function(a){this._alignment=a;this.updateLabel()},_getAlignment:function(){return this._alignment},setBoundingWidth:function(a){this._width=a;this.updateLabel()},_getBoundingWidth:function(){return this._width},
setLineBreakWithoutSpace:function(a){this._lineBreakWithoutSpaces=a;this.updateLabel()},setScale:function(a,c){cc.Node.prototype.setScale.call(this,a,c);this.updateLabel()},setScaleX:function(a){cc.Node.prototype.setScaleX.call(this,a);this.updateLabel()},setScaleY:function(a){cc.Node.prototype.setScaleY.call(this,a);this.updateLabel()},setFntFile:function(a){if(null!=a&&a!==this._fntFile){var c=cc.loader.getRes(a);c?(this._fntFile=a,this._config=c,a=cc.textureCache.addImage(c.atlasName),this._textureLoaded=
c=a.isLoaded(),this.texture=a,this._renderCmd._updateFntFileTexture(),c?this.createFontChars():a.addEventListener("load",function(a){this._textureLoaded=!0;this.texture=a;this.createFontChars();this._changeTextureColor();this.updateLabel();this.dispatchEvent("load")},this)):cc.log("cc.LabelBMFont.setFntFile() : Impossible to create font. Please check file")}},getFntFile:function(){return this._fntFile},setTexture:function(a){this._renderCmd.setTexture(a)},setAnchorPoint:function(a,c){cc.Node.prototype.setAnchorPoint.call(this,
a,c);this.updateLabel()},_setAnchorX:function(a){cc.Node.prototype._setAnchorX.call(this,a);this.updateLabel()},_setAnchorY:function(a){cc.Node.prototype._setAnchorY.call(this,a);this.updateLabel()},_atlasNameFromFntFile:function(a){},_kerningAmountForFirst:function(a,c){var b=0;if(this._configuration.kerningDictionary){var d=this._configuration.kerningDictionary[(a<<16|c&65535).toString()];d&&(b=d.amount)}return b},_getLetterPosXLeft:function(a){return a.getPositionX()*this._scaleX-a._getWidth()*
this._scaleX*a._getAnchorX()},_getLetterPosXRight:function(a){return a.getPositionX()*this._scaleX+a._getWidth()*this._scaleX*a._getAnchorX()},_isspace_unicode:function(a){a=a.charCodeAt(0);return 9<=a&&13>=a||32===a||133===a||160===a||5760===a||8192<=a&&8202>=a||8232===a||8233===a||8239===a||8287===a||12288===a},_utf8_trim_ws:function(a){var c=a.length;if(!(0>=c)&&(c-=1,this._isspace_unicode(a[c]))){for(var b=c-1;0<=b;--b)if(this._isspace_unicode(a[b]))c=b;else break;this._utf8_trim_from(a,c)}},
_utf8_trim_from:function(a,c){var b=a.length;c>=b||0>c||a.splice(c,b)}});(function(){var a=cc.LabelBMFont.prototype;cc.EventHelper.prototype.apply(a);cc.defineGetterSetter(a,"string",a.getString,a._setStringForSetter);cc.defineGetterSetter(a,"boundingWidth",a._getBoundingWidth,a.setBoundingWidth);cc.defineGetterSetter(a,"textAlign",a._getAlignment,a.setAlignment)})();cc.LabelBMFont.create=function(a,c,b,d,e){return new cc.LabelBMFont(a,c,b,d,e)};
...
cc.ProgressFromTo=cc.ActionInterval.extend({_to:0,_from:0,ctor:function(a,c,b){cc.ActionInterval.prototype.ctor.call(this);this._from=this._to=0;void 0!==b&&this.initWithDuration(a,c,b)},initWithDuration:function(a,c,b){return cc.ActionInterval.prototype.initWithDuration.call(this,a)?(this._to=b,this._from=c,!0):!1},clone:function(){var a=new cc.ProgressFromTo;a.initWithDuration(this._duration,this._from,this._to);return a},reverse:function(){return cc.progressFromTo(this._duration,this._to,this._from)},
startWithTarget:function(a){cc.ActionInterval.prototype.startWithTarget.call(this,a)},update:function(a){this.target instanceof cc.ProgressTimer&&(this.target.percentage=this._from+(this._to-this._from)*a)}});cc.progressFromTo=function(a,c,b){return new cc.ProgressFromTo(a,c,b)};cc.ProgressFromTo.create=cc.progressFromTo;(function(){cc.ProgressTimer.CanvasRenderCmd=function(a){cc.Node.CanvasRenderCmd.call(this,a);this._needDraw=!0;this._PI180=Math.PI/180;this._barRect=cc.rect(0,0,0,0);this._origin=cc.p(0,0);this._radius=0;this._endAngle=this._startAngle=270;this._counterClockWise=!1};var a=cc.ProgressTimer.CanvasRenderCmd.prototype=Object.create(cc.Node.CanvasRenderCmd.prototype);a.constructor=cc.ProgressTimer.CanvasRenderCmd;a.rendering=function(a,b,d){a=a||cc._renderContext;var e=a.getContext(),f=this._node,g=f._sprite,
h=g._renderCmd._textureCoord,k=g._renderCmd._displayedOpacity/255;if(0!==h.width&&0!==h.height&&g._texture&&h.validRect&&0!==k){a.setTransform(this._worldTransform,b,d);a.setCompositeOperation(g._blendFuncStr);a.setGlobalAlpha(k);var m=g._rect,n=g._offsetPosition,k=n.x,p=-n.y-m.height,s=m.width,m=m.height;a.save();g._flippedX&&(k=-k-s,e.scale(-1,1));g._flippedY&&(p=n.y,e.scale(1,-1));f._type===cc.ProgressTimer.TYPE_BAR?(f=this._barRect,e.beginPath(),e.rect(f.x*b,f.y*d,f.width*b,f.height*d),e.clip(),
e.closePath()):f._type===cc.ProgressTimer.TYPE_RADIAL&&(f=this._origin.x*b,n=this._origin.y*d,e.beginPath(),e.arc(f,n,this._radius*d,this._PI180*this._startAngle,this._PI180*this._endAngle,this._counterClockWise),e.lineTo(f,n),e.clip(),e.closePath());f=g._texture.getHtmlElementObj();g._renderCmd._colorized?e.drawImage(f,0,0,h.width,h.height,k*b,p*d,s*b,m*d):e.drawImage(f,h.renderX,h.renderY,h.width,h.height,k*b,p*d,s*b,m*d);a.restore();cc.g_NumberOfDraws++}};a.releaseData=function(){};a.initCmd=function(){};
a._updateProgress=function(){var a=this._node,b=a._sprite,d=b.width,e=b.height,f=a._midPoint;if(a._type===cc.ProgressTimer.TYPE_RADIAL){this._radius=Math.round(Math.sqrt(d*d+e*e));var g,h=!1,k=this._origin;k.x=d*f.x;k.y=-e*f.y;a._reverseDirection?(g=270,f=270-3.6*a._percentage):(f=-90,g=-90+3.6*a._percentage);b._flippedX&&(k.x-=2*d*a._midPoint.x,f=-f-180,g=-g-180,h=!h);b._flippedY&&(k.y+=2*e*a._midPoint.y,h=!h,f=-f,g=-g);this._startAngle=f;this._endAngle=g;this._counterClockWise=h}else h=a._barChangeRate,
k=a._percentage/100,a=this._barRect,h=cc.size(d*(1-h.x),e*(1-h.y)),k=cc.size((d-h.width)*k,(e-h.height)*k),h=cc.size(h.width+k.width,h.height+k.height),g=cc.p(d*f.x,e*f.y),k=g.x-h.width/2,0.5<f.x&&h.width/2>=d-g.x&&(k=d-h.width),d=g.y-h.height/2,0.5<f.y&&h.height/2>=e-g.y&&(d=e-h.height),a.x=0,e=1,b._flippedX&&(a.x-=h.width,e=-1),0<k&&(a.x+=k*e),a.y=0,e=1,b._flippedY&&(a.y+=h.height,e=-1),0<d&&(a.y-=d*e),a.width=h.width,a.height=-h.height};a._updateColor=function(){};a._syncStatus=function(a){var b=
this._node;if(b._sprite){var d=cc.Node._dirtyFlags,e=this._dirtyFlag,f=a?a._node:null;f&&f._cascadeColorEnabled&&a._dirtyFlag&d.colorDirty&&(e|=d.colorDirty);f&&f._cascadeOpacityEnabled&&a._dirtyFlag&d.opacityDirty&&(e|=d.opacityDirty);a&&a._dirtyFlag&d.transformDirty&&(e|=d.transformDirty);this._dirtyFlag=e;var b=b._sprite._renderCmd,g=b._dirtyFlag,f=g&d.colorDirty,g=g&d.opacityDirty;f&&b._syncDisplayColor();g&&b._syncDisplayOpacity();(f||g)&&b._updateColor();e&d.transformDirty&&this.transform(a)}};
a.updateStatus=function(){var a=this._node;if(a._sprite){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,a=a._sprite._renderCmd,e=a._dirtyFlag,f=e&b.colorDirty,e=e&b.opacityDirty;f&&a._updateDisplayColor();e&&a._updateDisplayOpacity();(f||e)&&a._updateColor();d&b.transformDirty&&this.transform(this.getParentRenderCmd(),!0);this._dirtyFlag=0}}})();(function(){cc.ProgressTimer.WebGLRenderCmd=function(a){cc.Node.WebGLRenderCmd.call(this,a);this._needDraw=!0;this._vertexWebGLBuffer=cc._renderContext.createBuffer();this._vertexDataCount=0;this._vertexArrayBuffer=this._vertexData=null;this._vertexDataDirty=!1};var a=cc.ProgressTimer.WebGLRenderCmd.prototype=Object.create(cc.Node.WebGLRenderCmd.prototype);a.constructor=cc.ProgressTimer.WebGLRenderCmd;a.rendering=function(a){var b=this._node;a=a||cc._renderContext;if(this._vertexData&&b._sprite){this._shaderProgram.use();
...
0}};a.updateStatus=function(){var a=this._node;if(a._sprite){var b=cc.Node._dirtyFlags,d=this._dirtyFlag,a=a._sprite._renderCmd,e=a._dirtyFlag,f=e&b.colorDirty,e=e&b.opacityDirty;f&&(a._updateDisplayColor(),this._dirtyFlag^=this._dirtyFlag&b.colorDirty);e&&(a._updateDisplayOpacity(),this._dirtyFlag^=this._dirtyFlag&b.opacityDirty);if(f||e)a._updateColor(),this._updateColor();d&b.transformDirty&&this.transform(this.getParentRenderCmd(),!0)}};a.releaseData=function(){this._vertexData&&(this._vertexArrayBuffer=
this._vertexData=null,this._vertexDataCount=0)};a.initCmd=function(){this._vertexArrayBuffer=this._vertexData=null;this._vertexDataCount=0;this._shaderProgram=cc.shaderCache.programForKey(cc.SHADER_POSITION_TEXTURECOLOR)};a._updateProgress=function(){var a=this._node._type;a===cc.ProgressTimer.TYPE_RADIAL?this._updateRadial():a===cc.ProgressTimer.TYPE_BAR&&this._updateBar();this._vertexDataDirty=!0};a._updateBar=function(){var a=this._node;if(a._sprite){var b,d=a._percentage/100;b=a._barChangeRate;
b=cc.pMult(cc.p(1-b.x+d*b.x,1-b.y+d*b.y),0.5);d=cc.pSub(a._midPoint,b);a=cc.pAdd(a._midPoint,b);0>d.x&&(a.x+=-d.x,d.x=0);1<a.x&&(d.x-=a.x-1,a.x=1);0>d.y&&(a.y+=-d.y,d.y=0);1<a.y&&(d.y-=a.y-1,a.y=1);if(this._reverseDirection){if(!this._vertexData){this._vertexDataCount=8;var e=cc.V2F_C4B_T2F.BYTES_PER_ELEMENT;this._vertexArrayBuffer=new ArrayBuffer(8*e);var f=[];for(b=0;8>b;b++)f[b]=new cc.V2F_C4B_T2F(null,null,null,this._vertexArrayBuffer,b*e);f[0].texCoords=this._textureCoordFromAlphaPoint(cc.p(0,
1));f[0].vertices=this._vertexFromAlphaPoint(cc.p(0,1));f[1].texCoords=this._textureCoordFromAlphaPoint(cc.p(0,0));f[1].vertices=this._vertexFromAlphaPoint(cc.p(0,0));f[6].texCoords=this._textureCoordFromAlphaPoint(cc.p(1,1));f[6].vertices=this._vertexFromAlphaPoint(cc.p(1,1));f[7].texCoords=this._textureCoordFromAlphaPoint(cc.p(1,0));f[7].vertices=this._vertexFromAlphaPoint(cc.p(1,0));this._vertexData=f}b=this._vertexData;b[2].texCoords=this._textureCoordFromAlphaPoint(cc.p(d.x,a.y));b[2].vertices=
this._vertexFromAlphaPoint(cc.p(d.x,a.y));b[3].texCoords=this._textureCoordFromAlphaPoint(cc.p(d.x,d.y));b[3].vertices=this._vertexFromAlphaPoint(cc.p(d.x,d.y));b[4].texCoords=this._textureCoordFromAlphaPoint(cc.p(a.x,a.y));b[4].vertices=this._vertexFromAlphaPoint(cc.p(a.x,a.y));b[5].texCoords=this._textureCoordFromAlphaPoint(cc.p(a.x,d.y));b[5].vertices=this._vertexFromAlphaPoint(cc.p(a.x,d.y))}else{if(!this._vertexData)for(this._vertexDataCount=4,e=cc.V2F_C4B_T2F.BYTES_PER_ELEMENT,this._vertexArrayBuffer=
new ArrayBuffer(4*e),this._vertexData=[],b=0;4>b;b++)this._vertexData[b]=new cc.V2F_C4B_T2F(null,null,null,this._vertexArrayBuffer,b*e);b=this._vertexData;b[0].texCoords=this._textureCoordFromAlphaPoint(cc.p(d.x,a.y));b[0].vertices=this._vertexFromAlphaPoint(cc.p(d.x,a.y));b[1].texCoords=this._textureCoordFromAlphaPoint(cc.p(d.x,d.y));b[1].vertices=this._vertexFromAlphaPoint(cc.p(d.x,d.y));b[2].texCoords=this._textureCoordFromAlphaPoint(cc.p(a.x,a.y));b[2].vertices=this._vertexFromAlphaPoint(cc.p(a.x,
a.y));b[3].texCoords=this._textureCoordFromAlphaPoint(cc.p(a.x,d.y));b[3].vertices=this._vertexFromAlphaPoint(cc.p(a.x,d.y))}this._updateColor()}};a._updateRadial=function(){var a=this._node;if(a._sprite){var b,d=a._midPoint;b=a._percentage/100;var e=2*cc.PI*(a._reverseDirection?b:1-b),a=cc.p(d.x,1),f=cc.pRotateByAngle(a,d,e),e=0;if(0===b)f=a,e=0;else if(1===b)f=a,e=4;else{var g=cc.FLT_MAX,h=cc.ProgressTimer.TEXTURE_COORDS_COUNT;for(b=0;b<=h;++b){var k=(b+(h-1))%h,m=this._boundaryTexCoord(b%h),k=
this._boundaryTexCoord(k);0===b?k=cc.pLerp(m,k,1-d.x):4===b&&(m=cc.pLerp(m,k,1-d.x));var n=cc.p(0,0);cc.pLineIntersect(m,k,d,f,n)&&(0!==b&&4!==b||0<=n.x&&1>=n.x)&&0<=n.y&&n.y<g&&(g=n.y,e=b)}f=cc.pAdd(d,cc.pMult(cc.pSub(f,d),g))}g=!0;this._vertexDataCount!==e+3&&(g=!1,this._vertexArrayBuffer=this._vertexData=null,this._vertexDataCount=0);if(!this._vertexData){h=this._vertexDataCount=e+3;m=cc.V2F_C4B_T2F.BYTES_PER_ELEMENT;this._vertexArrayBuffer=new ArrayBuffer(h*m);k=[];for(b=0;b<h;b++)k[b]=new cc.V2F_C4B_T2F(null,
null,null,this._vertexArrayBuffer,b*m);this._vertexData=k;if(!this._vertexData){cc.log("cc.ProgressTimer._updateRadial() : Not enough memory");return}}this._updateColor();h=this._vertexData;if(!g)for(h[0].texCoords=this._textureCoordFromAlphaPoint(d),h[0].vertices=this._vertexFromAlphaPoint(d),h[1].texCoords=this._textureCoordFromAlphaPoint(a),h[1].vertices=this._vertexFromAlphaPoint(a),b=0;b<e;b++)d=this._boundaryTexCoord(b),h[b+2].texCoords=this._textureCoordFromAlphaPoint(d),h[b+2].vertices=this._vertexFromAlphaPoint(d);
...
d.bl.texCoords.v),d=cc.p(d.tr.texCoords.u,d.tr.texCoords.v);b.textureRectRotated&&(b=a.x,a.x=a.y,a.y=b);return{u:e.x*(1-a.x)+d.x*a.x,v:e.y*(1-a.y)+d.y*a.y}};a._vertexFromAlphaPoint=function(a){var b=this._node._sprite;if(!b)return{x:0,y:0};var d=b.quad,b=cc.p(d.bl.vertices.x,d.bl.vertices.y),d=cc.p(d.tr.vertices.x,d.tr.vertices.y);return{x:b.x*(1-a.x)+d.x*a.x,y:b.y*(1-a.y)+d.y*a.y}};a._updateColor=function(){var a=this._node;if(a._sprite&&this._vertexData){for(var a=a._sprite.quad.tl.colors,b=this._vertexData,
d=0,e=this._vertexDataCount;d<e;++d)b[d].colors=a;this._vertexDataDirty=!0}}})();var res={map2_png:"res/map2.jpg",ui_12_png:"res/ui_12.png",ui_12_plist:"res/ui_12.js?file_type\x3dplist",boom_png:"res/boom.png",boom_plist:"res/boom.js?file_type\x3dplist",my_Mp3:"res/13.mp3",map_png:"res/map.png",map_plist:"res/map.js?file_type\x3dplist",fail_MP3:"res/fail3.mp3",success_MP3:"res/success.mp3"},g_resources=[res.map2_png,res.ui_12_plist,res.ui_12_png,res.boom_plist,res.boom_png,res.my_Mp3,res.map_plist,res.map_png,res.fail_MP3,res.success_MP3];var HelloWorldLayer=cc.Layer.extend({sprite:null,ctor:function(){this._super();var a=cc.winSize,c=new cc.MenuItemImage(res.CloseNormal_png,res.CloseSelected_png,function(){cc.log("Menu is clicked!")},this);c.attr({x:a.width-20,y:20,anchorX:0.5,anchorY:0.5});c=new cc.Menu(c);c.x=0;c.y=0;this.addChild(c,1);c=new cc.LabelTTF("Hello World","Arial",38);c.x=a.width/2;c.y=0;this.addChild(c,5);this.sprite=new cc.Sprite(res.HelloWorld_png);this.sprite.attr({x:a.width/2,y:a.height/2,scale:0.5,rotation:180});
this.addChild(this.sprite,0);this.sprite.runAction(cc.sequence(cc.rotateTo(2,0),cc.scaleTo(2,1,1)));c.runAction(cc.spawn(cc.moveBy(2.5,cc.p(0,a.height-40)),cc.tintTo(2.5,255,125,0)));return!0}}),HelloWorldScene=cc.Scene.extend({onEnter:function(){this._super();var a=new HelloWorldLayer;this.addChild(a)}});var StartLayer=cc.Layer.extend({touchListener:null,dianji:null,shine:null,isHelp:null,ctor:function(a){this._super();StartLayer.instance=this;this.isHelp=!0;var c=new cc.Sprite(res.map2_png);c.setPosition(cc.p(cc.winSize.width/2,cc.winSize.height/2));this.addChild(c);a?this.startGame():hoowuGame.gameLoadFinished(function(){this.startGame()}.bind(this))},startGame:function(){var a=new GameScene;cc.director.runScene(a)}}),StartScene=cc.Scene.extend({onEnter:function(){this._super();var a=new StartLayer;
this.addChild(a)}});var GameSceneLayer=cc.Layer.extend({_size:null,bg1:null,bg2:null,bg3:null,time1:null,time2:null,time3:null,time4:null,clockText:null,velocity:null,lister:null,shit:null,score:null,labelBar:null,time5:null,time6:null,node1:null,node2:null,bgArray:null,bg2Array:null,isbool:null,efFrames:null,isTrue:null,ctor:function(){this._super();this._size=cc.winSize;GameSceneLayer.instance=this;cc.spriteFrameCache.addSpriteFrames(res.map_plist);this._accumDt=this.frames=0;this.isbool=!0;this.efFrames=0;this.bgArray=
[];this.bg2Array=[];this.time6=this.time5=0;this.isTrue=!1;this.node1=new cc.Node;this.addChild(this.node1);this.node1.setPosition(cc.winSize.width/2,cc.winSize.height);this.node2=new cc.Node;this.addChild(this.node2);this.node2.setPosition(cc.p(cc.winSize.width/2,cc.winSize.height-1200));var a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg3.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,0));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg4.png"));
this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-200));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg5.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-400));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg6.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-600));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg3.png"));
this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-800));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg4.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-1E3));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg1.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,0));a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg2.png"));
this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-200));a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg3.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-400));a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg4.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-600));a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg5.png"));this.node1.addChild(a);
this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-800));a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg6.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-1E3));cc.spriteFrameCache.addSpriteFrames(res.ui_12_plist);this.time1=this.velocity=0;this.time2=3;this.score=this.time4=this.time3=0;StartLayer.instance.isHelp?(a=new HelpLayer,a.setLocalZOrder(300),StartLayer.instance.isHelp=!1,this.addChild(a)):this.schedule(this.updateTime,
1);this.clockText=new cc.LabelTTF(this.time2,"arial",60);this.addChild(this.clockText);this.clockText.setPosition(cc.p(this._size.width/2,this._size.height/2));a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("scoreText.png"));this.addChild(a);a.setPosition(cc.p(this._size.width/2,this._size.height-50));this.labelBar=new cc.LabelTTF(this.score.toString()+"M","arial",40);this.addChild(this.labelBar);this.labelBar.setPosition(cc.p(this._size.width/2,this._size.height-50));this.lister=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,
swallowTouches:!0,onTouchBegan:function(a,b){console.log(b);return!0},onTouchMoved:function(a,b){var d=b.getCurrentTarget(),e=a.getDelta();d.shit&&(e=cc.p(e.x+d.shit.x,d.shit.y),d.shit.setPosition(e))}});cc.eventManager.addListener(this.lister,this)},createBg2:function(){var a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg3.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,0));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg4.png"));
this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-200));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg5.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-400));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg6.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-600));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg3.png"));
this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-800));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg4.png"));this.node2.addChild(a);this.bg2Array.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-1E3));a.setVisible(!1)},createBg1:function(){var a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg5.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,0));a.setVisible(!1);
a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg6.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-200));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg3.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-400));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg4.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));
a.setPosition(cc.p(0,-600));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg5.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-800));a.setVisible(!1);a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("bg6.png"));this.node1.addChild(a);this.bgArray.push(a);a.setAnchorPoint(cc.p(0.5,1));a.setPosition(cc.p(0,-1E3));a.setVisible(!1)},gameover:function(){cc.eventManager.removeListener(this.lister);GamePlayLayer.instance.unschedule(GamePlayLayer.instance.updatePos);
GamePlayLayer.instance.unscheduleUpdate();GameSceneLayer.instance.unscheduleUpdate();GameSceneLayer.instance.unscheduleAllCallbacks();cc.audioEngine.stopMusic();g_soundEffect&&(this.isTrue?cc.audioEngine.playEffect(res.success_MP3,!1):cc.audioEngine.playEffect(res.fail_MP3,!1));new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("ui_re.png"));new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("ui_re.png"));hoowuGame.gameOver({isPass:this.isTrue},this.restartGame.bind(this))},restartGame:function(){cc.audioEngine.stopAllEffects();
this.onNewGame();g_soundMusic&&cc.audioEngine.playMusic(res.my_Mp3,!1)},onNewGame:function(){var a=new cc.Scene,c=new GameSceneLayer,b=new GamePlayLayer;c.init();b.init();a.addChild(c);a.addChild(b);cc.director.runScene(a)},addTtem:function(){this.moveScreen2();var a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("shitWave.png"));this.addChild(a);a.setPosition(cc.p(this._size.width/2,this._size.height+200));var c=cc.moveTo(1,cc.p(this._size.width/2,-200)),b=cc.callFunc(function(b){b.removeChild(a)});
a.runAction(cc.sequence(c,b));var c=cc.callFunc(function(a){a.changeShit1()}),d=cc.callFunc(function(a){a.changeShit2()}),e=cc.delayTime(1);this.runAction(cc.sequence(c,e,d,b))},moveScreen:function(){cc.log(" moveScreen ");this.getPosition();var a=cc.moveBy2(0.05,cc.p(10,this.y)),c=cc.moveBy2(0.05,cc.p(-10,this.y)),b=cc.moveBy2(0.05,cc.p(this.x,10)),d=cc.moveBy2(0.05,cc.p(this.x,-10)),a=cc.spawn(a,b),c=cc.spawn(c,d),c=cc.sequence(a,c),d=cc.callFunc(function(a){GameSceneLayer.instance.addShit()}),
a=cc.callFunc(function(a){a.setPosition(cc.p(0,0))});this.runAction(cc.sequence(cc.repeat(c,4),d,a))},moveScreen2:function(){cc.log("moveScreen");GameSceneLayer.instance.getPosition();var a=cc.moveBy(0.05,cc.p(10,this.y)),c=cc.moveBy(0.05,cc.p(-10,this.y)),b=cc.moveBy(0.05,cc.p(this.x,10)),d=cc.moveBy(0.05,cc.p(this.x,-10)),a=cc.spawn(a,b),c=cc.spawn(c,d),c=cc.sequence(a,c),d=cc.callFunc(function(a){a.setPosition(0,0)});this.runAction(cc.sequence(cc.repeat(c,4),d))},changeShit1:function(){var a=this.shit.getPosition();
this.removeChild(this.shit);this.shit=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("shi2.png"));this.addChild(this.shit);this.shit.setPosition(a)},changeShit2:function(){var a=this.shit.getPosition();this.removeChild(this.shit);this.shit=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("shi1.png"));this.addChild(this.shit);this.shit.setPosition(a)},addShit:function(){this.shit=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("cat.png"));this.addChild(this.shit);this.shit.setPosition(cc.p(this._size.width/
2,this._size.height-90));this.shit.setScale(0.1);this.shit.setLocalZOrder(100);var a=cc.scaleTo(0.5,1,1),c=cc.moveTo(0.5,cc.p(this._size.width/2,this._size.height/2+200)),a=cc.spawn(a,c);this.shit.runAction(a);a=cc.callFunc(function(a){GameSceneLayer.instance.current=(new Date).getTime();GameSceneLayer.instance.scheduleUpdate()});c=cc.delayTime(0.4);this.runAction(cc.sequence(c,a));a=cc.delayTime(0.5);c=cc.callFunc(function(a){GamePlayLayer.instance.scheduleUpdate()});GamePlayLayer.instance.runAction(cc.sequence(a,
c))},updateTime:function(){this.time2--;this.clockText.setString(this.time2);0==this.time2&&(this.velocity=3,this.unschedule(this.updateTime),this.removeChild(this.clockText),GameSceneLayer.instance.moveScreen())},_showStats:function(){this._frames++;var a=0;this._accumDt+=cc.director._deltaTime;this._accumDt>cc.DIRECTOR_FPS_INTERVAL&&(a=this._frames/this._accumDt,this._accumDt=this._frames=0);return a},update:function(a){this._showStats();a=(new Date).getTime()-this.current;this.efFrames=Math.max(1,
Math.floor(a/16));this.velocity=3;this.node1.y+=3*this.velocity*this.efFrames;this.node2.y+=3*this.velocity*this.efFrames;this.time5+=3*this.velocity*this.efFrames;this.time3+=3*this.velocity*this.efFrames;this.score+=3*this.velocity*this.efFrames;this.labelBar.setString(parseInt(this.score/10).toString()+"M");this.current=(new Date).getTime();for(a=0;a<this.bgArray.length;a++){var c=this.bgArray[a].getPosition();cc.log(cc.winSize.height);c=this.node1.y+c.y;c>=cc.winSize.height+200&&this.bgArray[a].setVisible(!1);
0<=c&&this.bgArray[a].setVisible(!0)}for(a=0;a<this.bg2Array.length;a++)c=this.bg2Array[a].getPosition(),c=this.node2.y+c.y,c>=cc.winSize.height+200&&this.bg2Array[a].setVisible(!1),0<=c&&this.bg2Array[a].setVisible(!0);if(this.node1.y>=cc.winSize.height+1200){this.node1.setPosition(cc.p(cc.winSize.width/2,this.node2.y+this.bg2Array[5].y-200));for(a=0;a<this.bgArray.length;a++)this.node1.removeChild(this.bgArray[a]);this.bgArray=[];this.createBg1()}if(this.node2.y>=cc.winSize.height+1200){this.node2.setPosition(cc.p(cc.winSize.width/
2,this.node1.y+this.bgArray[5].y-200));for(a=0;a<this.bg2Array.length;a++)this.node2.removeChild(this.bg2Array[a]);this.bg2Array=[];this.createBg2()}}}),HelpLayer=cc.LayerColor.extend({m_touchListener:null,ctor:function(){this._super(cc.color(0,0,0));this.setOpacity(128);var a=cc.winSize,c=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("help.png"));c.setPosition(cc.p(a.width/2,a.height/2));c.setLocalZOrder(250);this.addChild(c);a={event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan};
cc.eventManager.addListener(a,this);this.m_touchListener=a},onTouchBegan:function(a,c){cc.log("touchBegan");var b=c.getCurrentTarget();GameSceneLayer.instance.schedule(GameSceneLayer.instance.updateTime,1);g_soundMusic&&cc.audioEngine.playMusic(res.my_Mp3,!1);b.removeFromParent();return!0}}),GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameSceneLayer,c=new GamePlayLayer;this.addChild(a);this.addChild(c)}});var GamePlayLayer=cc.Layer.extend({posY:null,_size:null,velocity:null,itemArray:null,time4:null,endPoint:null,iszhen:null,iszhen2:null,iszhen3:null,ctor:function(){this._super();this._size=cc.winSize;cc.spriteFrameCache.addSpriteFrames(res.boom_plist);GamePlayLayer.instance=this;this.posY=0;this.itemArray=[];this.time4=0;this.isbool=!0;this.addTarget();this.iszhen3=this.iszhen2=this.iszhen=!0;this.schedule(this.updatePos,0.1)},shiLang:function(){GameSceneLayer.instance.velocity=0;cc.eventManager.removeListener(GameSceneLayer.instance.lister);
GameSceneLayer.instance.unscheduleAllCallbacks();var a=this.convertToNodeSpace(GameSceneLayer.instance.shit.getPosition());GameSceneLayer.instance.removeChild(GameSceneLayer.instance.shit);var c=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("boom1.png"));this.addChild(c);c.setPosition(a);for(var a=new cc.Animation,b=1;9>b;b++){var d=cc.spriteFrameCache.getSpriteFrame("boom"+b+".png");a.addSpriteFrame(d)}a.setDelayPerUnit(0.1);a.setRestoreOriginalFrame(!0);a=cc.animate(a);b=cc.callFunc(function(a){GamePlayLayer.instance.removeChild(c)});
c.runAction(cc.sequence(a,b));a=cc.delayTime(0.5);b=cc.callFunc(function(a){GameSceneLayer.instance.gameover()});this.runAction(cc.sequence(a,b))},absorb:function(a){GameSceneLayer.instance.velocity=0;cc.eventManager.removeListeners(GameSceneLayer.instance.lister);GameSceneLayer.instance.unscheduleAllCallbacks();var c=cc.scaleTo(0.3,0.1,0.1);a=cc.moveTo(0.1,a.x,a.y);c=cc.spawn(c,a);a=cc.callFunc(function(a){GameSceneLayer.instance.removeChild(GameSceneLayer.instance.shit)});var b=cc.callFunc(function(){GameSceneLayer.instance.velocity=
0});GameSceneLayer.instance.shit.runAction(cc.sequence(c,a,b));cc.eventManager.removeListener(GameSceneLayer.instance.lister);GameSceneLayer.instance.unscheduleAllCallbacks();c=cc.delayTime(0.5);a=cc.callFunc(function(a){GameSceneLayer.instance.gameover()});this.runAction(cc.sequence(c,a))},updatePos:function(){for(var a=0;a<this.itemArray.length;a++){var c=this.convertToWorldSpace(this.itemArray[a].getPosition());1280<=c.y&&(this.itemArray[a].removeFromParent(),this.itemArray.splice(a,1),cc.log("remove"));
if(GameSceneLayer.instance.shit)var b=cc.rect(GameSceneLayer.instance.shit.x-GameSceneLayer.instance.shit.getBoundingBox().width/2,GameSceneLayer.instance.shit.y-GameSceneLayer.instance.shit.getBoundingBox().height/2,84,84);this.itemArray[a]&&GameSceneLayer.instance.shit&&(c=cc.rect(c.x-this.itemArray[a].getBoundingBox().width/2,c.y-this.itemArray[a].getBoundingBox().height/2,this.itemArray[a].getBoundingBox().width,this.itemArray[a].getBoundingBox().height),cc.rectIntersectsRect(b,c)&&(this.unschedule(this.updatePos),
this.convertToNodeSpace(cc.p(this.itemArray[a].y,this.itemArray[a].x)),cc.log("ID!!"+this.itemArray[a].ID),cc.log("pengzhuang!!!!!!!!!!!"),1==this.itemArray[a].ID?(cc.log("zhongyu dengdaoni !!"),this.shiLang()):2==this.itemArray[a].ID?(cc.eventManager.removeListener(this.lister,GameSceneLayer.instance),c=this.convertToWorldSpace(this.itemArray[a].getPosition()),this.absorb(c)):3==this.itemArray[a].ID&&this.shiLang(),Math.floor()),103>GameSceneLayer.instance.shit.x-GameSceneLayer.instance.shit.getBoundingBox().width/
2||520<GameSceneLayer.instance.shit.x+GameSceneLayer.instance.shit.getBoundingBox().width/2)&&(this.unschedule(this.updatePos),this.shiLang())}},update:function(a){this.velocity=GameSceneLayer.instance.velocity*GameSceneLayer.instance.efFrames;this.y+=3*this.velocity;700<=GameSceneLayer.instance.time3&&(GameSceneLayer.instance.time3=0,this.time4++,this.addTarget());4==this.time4&&this.isbool&&(this.isbool=!1,this.endPoint=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("end.png")),this.addChild(this.endPoint),
this.endPoint.setPosition(this.convertToNodeSpace(cc.p(cc.winSize.width/2,-1800))));a=GameSceneLayer.instance.shit.y;if(this.endPoint){var c=this.endPoint.getPosition().y+this.y;a<=c-100&&(GameSceneLayer.instance.isTrue=!0,this.unscheduleUpdate(),GameSceneLayer.instance.unscheduleUpdate(),cc.eventManager.removeListener(this.lister),GamePlayLayer.instance.unschedule(GamePlayLayer.instance.updatePos),cc.log("!!!!!!!!!!!!!!!!!!!"),a=cc.delayTime(0.5),c=cc.callFunc(function(a){GameSceneLayer.instance.gameover()}),
this.runAction(cc.sequence(a,c)))}},addTarget:function(){this.posY=-100;var a=Math.round(2*Math.random())+1;if(2==a)Math.round(2*Math.random()),1==Math.round(1*Math.random())+1?(Math.round(1*Math.random()),this.iszhen?(this.iszhen=!1,a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("anchor3.png"))):(this.iszhen=!0,a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("anchor2.png"))),this.addChild(a),a.setPosition(this.convertToNodeSpace(cc.p(this._size.width-175,this.posY)))):(this.iszhen?(this.iszhen=
!1,a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("anchor3.png")),a.setFlippedX(!0)):(this.iszhen=!0,a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("anchor1.png"))),this.addChild(a),a.setPosition(this.convertToNodeSpace(cc.p(175,this.posY)))),a.ID=1,this.itemArray.push(a);else if(1==a)if(this.iszhen3){this.iszhen3=!1;a=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("xuanwo.png"));this.addChild(a);var c=Math.round(2*Math.random())+1;1==c?a.setPosition(this.convertToNodeSpace(cc.p(this._size.width/
2,this.posY))):2==c?a.setPosition(this.convertToNodeSpace(cc.p(this._size.width-180,this.posY))):3==c&&a.setPosition(this.convertToNodeSpace(cc.p(180,this.posY)));c=cc.rotateBy(0.1,-60);a.runAction(cc.repeatForever(c));a.ID=2;this.itemArray.push(a)}else this.iszhen3=!0,this.addTarget();else if(3==a)if(this.iszhen2){this.iszhen2=!1;var b=new cc.Sprite(cc.spriteFrameCache.getSpriteFrame("fish.png"));this.addChild(b);b.setPosition(this.convertToNodeSpace(cc.p(this._size.width-180,this.posY)));b.setScale(0.7);
var a=cc.moveTo(1.5,this.convertToNodeSpace(cc.p(180,this.posY))),c=cc.callFunc(function(a){b.setFlippedX(!1)}),d=cc.moveTo(1.5,this.convertToNodeSpace(cc.p(this._size.width-180,this.posY))),e=cc.callFunc(function(a){b.setFlippedX(!0)}),a=cc.sequence(c,a,e,d);b.runAction(cc.repeatForever(a));b.ID=3;this.itemArray.push(b)}else this.iszhen2=!0,this.addTarget()}});var GameOverLayer=cc.LayerColor.extend({m_touchListener:null,ctor:function(){this._super(cc.color(0,0,0));this.setOpacity(128);var a={event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!0,onTouchBegan:this.onTouchBegan};cc.eventManager.addListener(a,this);this.m_touchListener=a},onTouchBegan:function(a,c){var b=c.getCurrentTarget();return b.isVisible()&&b.isTouchInside(b,a)?!0:!1},isTouchInside:function(a,c){if(!a||!a.getParent())return!1;var b=c.getLocation(),b=a.convertToNodeSpace(b);return cc.rectContainsPoint(a.getBoundingBox(),
b)}});cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(!1);cc.view.adjustViewPort(!0);cc.view.enableAutoFullScreen(!1);cc.view.setDesignResolutionSize(640,960,cc.ResolutionPolicy.FIXED_WIDTH);cc.view.resizeWithBrowserSize(!0);cc.LoaderScene.visible=!1;cc.LoaderScene.preload(g_resources,function(){cc.director.runScene(new StartScene)},this)};cc.game.run();