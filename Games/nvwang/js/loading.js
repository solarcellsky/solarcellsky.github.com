...
(lib.Symbol1dsfsd = function() {
	...
	this.instance.setTransform(-0.2,-0.1,0.513,0.513);
...
(lib.lo2 = function() {
	...
	// 100
	this.num_txt = new cjs.Text("0%", "bold 15px 'Arial'", "#FFFFFF");
...
(lib.Symbolsdfdf = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:2.2},7).to({rotation:0},7).wait(1));
...
(lib.lo = function() {
	...
	this.instance.setTransform(150.5,164.3,1,1,0,0,0,72.5,70.4);
...
(lib._123 = function(mode,startPosition,loop) {
	...
	this.num_mc.setTransform(130.7,114.5,1,1,0,0,0,42,39.5);

	this.timeline.addTween(cjs.Tween.get(this.num_mc).to({x:590.7},99).wait(1));

	// loading1.png
	this.instance = new lib.lo();
	this.instance.setTransform(26.6,155.5,1,1,0,0,0,142.5,155.5);
...
(lib.loading = function() {
	...
	this.loading_mc.setTransform(320.5,515.5,1,1,0,0,0,320.5,515.5);
