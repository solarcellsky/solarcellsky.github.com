...
var Xingkec = {
    //游戏基本对象
      ...
      if (r != null) return unescape(r[2]); return null;
        ...
        PostVoice:function(fail_function,success_function,mediaID,shareconfig){
            $.ajax({
                type: "POST", //用POST方式传输
                dataType: "JSON", //数据格式:JSON
                url: 'ajax/ajaxVoice.php', //目标地址
                data: {mediaId:mediaID,title:shareconfig.title,pic:shareconfig.pic,guid:shareconfig.guid},
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    fail_function;
                },
                success: function (data){
        ...
        ShareUser:function(fail_function,success_function){
            $.ajax({
                type: "POST", //用POST方式传输
                dataType: "JSON", //数据格式:JSON
                url: '../buyu/ajaxshare_tj.php', //目标地址
                data: {fen:'2'},
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    fail_function;
                },
...
var Games = {
    ...
    ConfigShare: function(shareTitle,shareUserTitle,shareUrl,shareIMG,success_function){
	    ...
	    ConfigMesgShare: function(shareTitle,shareUserTitle,shareUrl,shareIMG,success_function){
	    ...
	    ConfigTimeLineShare: function(shareTitle,shareUserTitle,shareUrl,shareIMG,success_function){
