...
var __extends = this.__extends || function (t, e) {
	...
	function e(e, a, r) {
		...
		this.addChild(Helper.createText(e.toString(), 360, 310, 50)),
		o = Helper.createText("\u4f60\u73a9\u5230\u3010" + r + "\u3011\u6298\u621f\u4e86", 120, 3 * GloabData.CONST_HEIGHT / 4 - 280, 30),
		o.textColor = 9315107,
		o.width = 400,
		this.addChild(o),
		o = Helper.createText("\u83b7\u5f97\u4e86" + e*10 + "\u5206", 120, 3 * GloabData.CONST_HEIGHT / 4 - 245, 30),
		o.textColor = 9315107,
		o.width = 400,
		this.addChild(o),
		o = Helper.createText("\u53f7\u79f0\u3010" + this.getSayWord(e) + "\u3011", 120, 3 * GloabData.CONST_HEIGHT / 4 - 210, 30),
		o.textColor = 9315107,
		o.width = 400,
		this.addChild(o),
		o = Helper.createText("\u5f00\u5fc3\u4e0d\uff1f", 120, 3 * GloabData.CONST_HEIGHT / 4 - 175, 30),
		o.textColor = 9315107,
		o.width = 400,
		this.addChild(o),
		function (t, e, a, r) {
...
var __extends = this.__extends || function (t, e) {
	...
	function e() {
		...
		this.txtScore = Helper.createText("0", 470, 40, 30),
		this.txtScore.anchorX = .5,
		this.txtScore.anchorY = .5,
		this.addChild(this.txtScore),
		this.txtState = Helper.createText("0", 190, 40, 30),
		this.txtState.anchorX = .5,
		this.txtState.anchorY = .5,
		this.addChild(this.txtState),
		this.txtWordTip = Helper.createText("", GloabData.CONST_WIDTH / 2, 110, 40),
...
var __extends = this.__extends || function (t, e) {
	...
	e.prototype.createTip = function () {
		...
		t = Helper.createBitMap("gameIntro", GloabData.CONST_WIDTH / 2, 330),
		t.anchorX = .5,
		t.anchorY = .5,
		this.spTipLayer.addChild(t),
		t = Helper.createBitMap("playBtn", GloabData.CONST_WIDTH / 2, 700),
		t.anchorX = .5,
		t.anchorY = .5,
		this.spTipLayer.addChild(t),
		egret.Tween.get(t, {
...
var __extends = this.__extends || function (t, e) {
	...
	function e() {
		...
		e = Helper.createBitMap("startBtn", GloabData.CONST_WIDTH / 2, 700),
		e.anchorX = .5,
		e.anchorY = .5,
		this.addChild(e),
		this.touchEnabled = !0,
		this.addEventListener(egret.TouchEvent.TOUCH_TAP, this.touchHander, this),
		e = Helper.createText("\u58f9\u9009\u79d1\u6280 \u5168\u7a0b\u6280\u672f\u652f\u6301", GloabData.CONST_WIDTH / 2, 930, 20),
		e.anchorX = .5,
		e.anchorY = .5,
		e.width = 1e3,
		this.addChild(e),
