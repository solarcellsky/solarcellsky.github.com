...
var MyLayer = cc.Layer.extend({
    ...
    initUI:function(){
        ...
        //开始按钮
        //var sp_startNormal = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_startGame_png));
        //var sp_startSelected = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_startGame_png));
        //sp_startSelected.setOpacity(150);
        //var sp_startDisabled = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_startGame_png));
        //sp_startDisabled.setOpacity(150);
        //var btn_start = new cc.MenuItemSprite(sp_startNormal,sp_startSelected,self.startGame,self);
        //btn_start.setAnchorPoint(0.5,0.5);
        //btn_start.setPosition(size_bg.width*0.52,size_bg.height*0.50);

  //      var btn_start = self.m_btnStart = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_startGame_png));
        var btn_start = self.m_btnStart = new cc.Sprite(res.btn_start_png);
        btn_start.setAnchorPoint(0.5,0.5);
        btn_start.setPosition(size_bg.width*0.5,size_bg.height*0.50);
    ...
    startGame:function(pSender){
        ...
        var sp_bg = self.m_bg = new cc.Sprite(res.bg_yindao2_jpg);
        sp_bg.setAnchorPoint(0,0);
        sp_bg.setPosition(0,0);
        self.addChild(sp_bg);
        var size_bg = sp_bg.getContentSize();
        ...
        var sp_goSelected = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_go_png));
        sp_goSelected.setOpacity(150);
        var sp_goDisabled = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_go_png));
        sp_goDisabled.setOpacity(150);
        var btn_go = new cc.MenuItemSprite(sp_goNormal,sp_goSelected,sp_goDisabled,self.trueStartGame,self);
        btn_go.setAnchorPoint(0.5,0.5);
        btn_go.setPosition(size_bg.width*0.5,size_bg.height*0.11);
    ...
    //开始游戏
    startGame2:function(pSender){
        var self = this;
        self.m_bg.removeFromParent(true);

        var sp_bg = self.m_bg = new cc.Sprite(res.bg_gameOver_jpg);
        sp_bg.setAnchorPoint(0,0);
        sp_bg.setPosition(0,0);
        self.addChild(sp_bg);
        var size_bg = sp_bg.getContentSize();

        var sp_retNormal = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_return_png));
        var sp_retSelected = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_return_png));
        sp_retSelected.setOpacity(150);
        var sp_reDisabled = new cc.Sprite(cc.spriteFrameCache.getSpriteFrame(res_name.btn_return_png));
        sp_reDisabled.setOpacity(150);
        var btn_return = new cc.MenuItemSprite(sp_retNormal,sp_retSelected,sp_reDisabled,function(){
            g_againGame();
        },self);
        btn_return.setAnchorPoint(0.5,0.5);
        btn_return.setPosition(size_bg.width*0.5,size_bg.height*0.09);

        var menu = new cc.Menu(btn_return);
        menu.setPosition(0,0);
        sp_bg.addChild(menu);
    },
