...
//        g_updateScore(self.m_curScore,function(){
   //         cc.container.style.display = "none";
            ...
            //if(isUpdateTel) {
                ...
                lbl_curScore.setColor(cc.color(0, 0, 0, 255));
                lbl_curScore.setAnchorPoint(0.5, 0.5);
                lbl_curScore.setPosition(size_bg.width * 0.615, size_bg.height * 0.66);
                sp_gameOver.addChild(lbl_curScore);

                var lbl_curRand = new cc.LabelTTF("...", "Arial", 30);
                lbl_curRand.setColor(cc.color(0, 0, 0, 255));
                lbl_curRand.setAnchorPoint(0.5, 0.5);
                lbl_curRand.setPosition(size_bg.width * 0.615, size_bg.height * 0.62);
                sp_gameOver.addChild(lbl_curRand);

                var lbl_bestScore = new cc.LabelTTF("...", "Arial", 30);
                lbl_bestScore.setColor(cc.color(0, 0, 0, 255));
                lbl_bestScore.setAnchorPoint(0.5, 0.5);
                lbl_bestScore.setPosition(size_bg.width * 0.615, size_bg.height * 0.57);
                sp_gameOver.addChild(lbl_bestScore);

                var lbl_bestRand = new cc.LabelTTF("...", "Arial", 30);
                lbl_bestRand.setColor(cc.color(0, 0, 0, 255));
                lbl_bestRand.setAnchorPoint(0.5, 0.5);
                lbl_bestRand.setPosition(size_bg.width * 0.615, size_bg.height * 0.52);
 ...
 //       });
    ...
    cutBomb:function(){
        ...
        btn_again.setAnchorPoint(0.5,0.5);
        btn_again.setPosition(size_bg.width*0.5,size_bg.height*0.28);
