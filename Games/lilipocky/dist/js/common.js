...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + ".js/" + ({"0":"final","1":"index","2":"info","3":"show","4":"showpage"}[chunkId]||chunkId) + ".js";
...
/***/ function(module, exports) {
	...
	exports.default = {
	    img: null,
	    serverPath: "http://lilipocky.gewoodigital.com/"
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// data-baidu="文字|事件"
	$(document).on('click', '[data-baidu]', function (e) {
	    return track(e);
	}).on('touchstart', '[data-baidu-touch]', function (e) {
	    return track(e);
	});

	function track(e) {
	    var _$$data$split = $(e.target).data('baidu').split('|', 2);

	    var _$$data$split2 = (0, _slicedToArray3.default)(_$$data$split, 2);

	    var text = _$$data$split2[0];
	    var event = _$$data$split2[1];
	 ...
	 * 百度统计事件
	 * @param text 文字
	 * @param [event] 事件 默认click
	 */
	function trackEvent() {
	    var text = arguments.length <= 0 || arguments[0] === undefined ? '' : arguments[0];
	    var event = arguments.length <= 1 || arguments[1] === undefined ? 'click' : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(26)(IteratorPrototype, __webpack_require__(34)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {var Data=__webpack_require__(4);
	var hex_sha1=__webpack_require__(80);
	var dtd = $.Deferred();
	var Weixin = {};
	var ticket;
	...
	Weixin.init = function () {
	    ...
	    return $.getJSON("http://lilipocky.gewoodigital.com/ticket?callback=?")
	    .then(function (res) {
	        if (!res.success) {
