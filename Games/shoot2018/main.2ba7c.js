(function () {
    ...
    function boot () {
        ...
        function setLoadingDisplay () {
            ...
            var progressBar = splash.querySelector('.progress-bar2 span#txt');
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.59956.js';
        if (jsList) {
