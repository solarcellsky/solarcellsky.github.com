    ...
    var weatherWidget = function() {
        ...
        if (navigator.geolocation) {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                var data_hourly = 'http://api.openweathermap.org/data/2.5/forecast/hourly?lat=' + position.coords.latitude + '&lon=' + position.coords.longitude + '&cnt=1&units=metric&lang=zh_cn&callback=?';
                ...
                var data_temperature = 'http://api.openweathermap.org/data/2.5/forecast/daily?lat=' + position.coords.latitude + '&lon=' + position.coords.longitude + '&cnt=15&units=metric&lang=zh_cn&callback=?';
